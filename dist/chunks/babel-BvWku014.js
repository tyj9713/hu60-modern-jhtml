...
t(r, {
	...
	__js_expression: () => Ai,
	__ts_expression: () => ji,
	__vue_event_binding: () => Oi,
	__vue_expression: () => Ai,
	__vue_ts_event_binding: () => ki,
	__vue_ts_expression: () => ji,
	babel: () => Oi,
	"babel-flow": () => Mi,
	"babel-ts": () => ki
});
var i = (e, t) => (n, r, ...i) => n | 1 && r == null ? void 0 : (t.call(r) ?? r[e]).apply(r, i), a = String.prototype.replaceAll ?? function(e, t) {
	return e.global ? this.replace(e, t) : this.split(e).join(t);
}, o = i("replaceAll", function() {
	if (typeof this == "string") return a;
}), s = Object.hasOwn ?? Function.prototype.call.bind(Object.prototype.hasOwnProperty), c = class {
	constructor(e, t, n) {
...
function u(e, t) {
	...
	return new c(n, r + t, i + t);
}
var d = "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED", f = {
...
}, m = (e) => e.type === "UpdateExpression" ? p.UpdateExpression[`${e.prefix}`] : p[e.type], ee = {
...
- Did you mean \`import { "${e}" as foo }\`?`,
	ImportCallArity: ({ phase: e }) => `\`import${e ? `.${e}` : ""}()\` requires exactly one or two arguments.`,
	ImportCallNotNewExpression: ({ phase: e }) => `Cannot use new with import${e ? `.${e}` : ""}().`,
	ImportCallSpreadArgument: ({ phase: e }) => `\`...\` is not allowed in \`import${e ? `.${e}` : ""}()\`.`,
	...
	InvalidLhs: ({ ancestor: e }) => `Invalid left-hand side in ${m(e)}.`,
	InvalidLhsBinding: ({ ancestor: e }) => `Binding invalid left-hand side in ${m(e)}.`,
	InvalidLhsOptionalChaining: ({ ancestor: e }) => `Invalid optional chaining in the left-hand side of ${m(e)}.`,
	...
	PipeUnparenthesizedBody: ({ type: e }) => `Hack-style pipe body cannot be an unparenthesized ${m({ type: e })}; please wrap it in parentheses.`,
...
function se({ toMessage: e, code: t, reasonCode: n, syntaxPlugin: r }) {
	let i = n === "MissingPlugin" || n === "MissingOneOfPlugins";
	return function a(o, s, l) {
		let u = /* @__PURE__ */ SyntaxError();
		return u.code = t, u.reasonCode = n, u.loc = o, u.pos = s, u.syntaxPlugin = r, i && (u.missingPlugin = l.missingPlugin), oe(u, "clone", function(e = {}) {
			let { line: t, column: n, index: r = s } = e.loc ?? o;
			return a(new c(t, n), r, {
				...l,
				...e.details
			});
		}), oe(u, "details", l), Object.defineProperty(u, "message", {
			configurable: !0,
			get() {
				let t = `${e(l)} (${o.line}:${o.column})`;
...
function le(e) {
	...
	else if (e.startColumn == null || e.startIndex == null) throw Error("With a `startLine > 1` you must also specify `startIndex` and `startColumn`.");
	if (t.sourceType === "commonjs") {
		if (e.allowAwaitOutsideFunction != null) throw Error("The `allowAwaitOutsideFunction` option cannot be used with `sourceType: 'commonjs'`.");
		if (e.allowReturnOutsideFunction != null) throw Error("`sourceType: 'commonjs'` implies `allowReturnOutsideFunction: true`, please remove the `allowReturnOutsideFunction` option or use `sourceType: 'script'`.");
		if (e.allowNewTargetOutsideFunction != null) throw Error("`sourceType: 'commonjs'` implies `allowNewTargetOutsideFunction: true`, please remove the `allowNewTargetOutsideFunction` option or use `sourceType: 'script'`.");
	}
	return t;
}
function _(e) {
	let { start: t, end: n } = e.loc;
	return e.loc.start = new c(t.line, t.column), e.loc.end = new c(n.line, n.column), e;
}
var ue = (e) => class extends e {
	createPosition(e) {
		return new c(e.line, e.column);
	}
	parse() {
		let e = super.parse();
		return this.optionFlags & 512 && (e.tokens = e.tokens.map(_)), _(e);
	}
	...
	estreeParseChainExpression(e, t) {
		...
		return n.expression = e, this.finishNodeAtNode(n, "ChainExpression", t);
	}
	directiveToStmt(e) {
		let t = e.value;
	...
	isValidLVal(e, t, n, r) {
		return e === "Property" ? "value" : super.isValidLVal(e, t, n, r);
	}
	isAssignable(e, t) {
	...
	toAssignable(e, t = !1) {
		if (e != null && this.isObjectProperty(e)) {
			let { key: n, value: r } = e;
			this.isPrivateName(n) && this.classScope.usePrivateName(this.getPrivateNameSV(n), n.start), this.toAssignable(r, t);
		} else super.toAssignable(e, t);
	}
	toAssignableObjectExpressionProp(e, t, n) {
		e.type === "Property" && (e.kind === "get" || e.kind === "set") ? this.raise(g.PatternHasAccessor, e.key) : e.type === "Property" && e.method ? this.raise(g.PatternHasMethod, e.key) : super.toAssignableObjectExpressionProp(e, t, n);
	}
	finishCallExpression(e, t) {
		let n = super.finishCallExpression(e, t);
		return n.callee.type === "Import" ? (this.castNodeTo(n, "ImportExpression"), n.source = n.arguments[0], n.options = n.arguments[1] ?? null, delete n.arguments, delete n.callee) : n.type === "OptionalCallExpression" ? this.castNodeTo(n, "CallExpression") : n.optional = !1, n;
	}
	parseExport(e, t) {
	...
	stopParseSubscript(e, t) {
		...
		return t.optionalChainMember ? this.estreeParseChainExpression(n, e) : n;
	}
	...
	finishNodeAt(e, t, n) {
		return _(super.finishNodeAt(e, t, n));
	}
	finishNodeAtNode(e, t, n) {
		return _(super.finishNodeAtNode(e, t, n));
	}
	finishNode(e, t) {
...
var w = -1, he = [], ge = [], _e = [], ve = [], ye = [], be = [];
function T(e, t = {}) {
	return ++w, ge.push(e), _e.push(t.binop ?? -1), ve.push(t.beforeExpr ?? !1), ye.push(t.startsExpr ?? !1), be.push(t.prefix ?? !1), he.push(new pe(e, t)), w;
}
function E(e, t = {}) {
	return ++w, me.set(e, w), ge.push(e), _e.push(t.binop ?? -1), ve.push(t.beforeExpr ?? !1), ye.push(t.startsExpr ?? !1), be.push(t.prefix ?? !1), he.push(new pe("name", t)), w;
}
var xe = {
	bracketL: T("[", {
		beforeExpr: v,
	...
	_for: S("for", { isLoop: de }),
	_while: S("while", { isLoop: de }),
...
function M(e) {
	return e < 65 ? e === 36 : e <= 90 ? !0 : e < 97 ? e === 95 : e <= 122 ? !0 : e <= 65535 ? e >= 170 && Ue.test(String.fromCharCode(e)) : Ge(e, Ve);
}
function N(e) {
	return e < 48 ? e === 36 : e < 58 ? !0 : e < 65 ? !1 : e <= 90 ? !0 : e < 97 ? e === 95 : e <= 122 ? !0 : e <= 65535 ? e >= 170 && We.test(String.fromCharCode(e)) : Ge(e, Ve) || Ge(e, He);
}
var Ke = {
...
}, qe = new Set(Ke.keyword), Je = new Set(Ke.strict), Ye = new Set(Ke.strictBind);
function Xe(e, t) {
	return t && e === "await" || e === "enum";
}
function Ze(e, t) {
	return Xe(e, t) || Je.has(e);
}
function Qe(e) {
	return Ye.has(e);
}
...
var nt = /* @__PURE__ */ new Set(/* @__PURE__ */ "break.case.catch.continue.debugger.default.do.else.finally.for.function.if.return.switch.throw.try.var.const.while.with.new.this.super.class.extends.export.import.null.true.false.in.instanceof.typeof.void.delete.implements.interface.let.package.private.protected.public.static.yield.eval.arguments.enum.await".split("."));
function rt(e) {
	return nt.has(e);
}
var it = class {
	...
	declareName(e, t, n) {
		...
		if (t & 8 || t & 16) {
			...
			t & 16 ? i |= 4 : (r.firstLexicalName ||= e, i |= 2), r.names.set(e, i), t & 8 && this.maybeExportDefined(r, e);
		} else if (t & 4) for (let i = this.scopeStack.length - 1; i >= 0 && (r = this.scopeStack[i], this.checkRedeclarationInScope(r, e, t, n), r.names.set(e, (r.names.get(e) || 0) | 1), this.maybeExportDefined(r, e), !(r.flags & 3715)); --i);
	...
	checkRedeclarationInScope(e, t, n, r) {
		this.isRedeclaredInScope(e, t, n) && this.parser.raise(g.VarRedeclaration, r, { identifierName: t });
	}
	isRedeclaredInScope(e, t, n) {
		if (!(n & 1)) return !1;
		if (n & 8) return e.names.has(t);
		let r = e.names.get(t) || 0;
...
var pt = /\*?\s*@((?:no)?flow)\b/, mt = (e) => class extends e {
	flowPragma = void 0;
	getScopeHandler() {
		return st;
	}
	...
	finishToken(e, t) {
		e !== 130 && e !== 9 && e !== 24 && this.flowPragma === void 0 && (this.flowPragma = null), super.finishToken(e, t);
	}
	addComment(e) {
	...
	flowParseTypeAndPredicateInitialiser(e) {
		...
		let n = null, r = null;
		return e && this.match(50) ? (this.state.inType = t, r = this.flowParsePredicate()) : (n = this.flowParseType(), this.state.inType = t, this.match(50) && (r = this.flowParsePredicate())), [n, r];
	}
	...
	flowParseDeclareFunction(e) {
		...
		this.match(43) ? n.typeParameters = this.flowParseTypeParameterDeclaration() : n.typeParameters = null, this.expect(6);
	...
	flowParseDeclare(e, t) {
		...
		if (this.match(78)) return this.flowParseDeclareExportDeclaration(e, t);
		throw this.unexpected();
	}
	flowParseDeclareVariable(e) {
		return this.next(), e.id = this.flowParseTypeAnnotatableIdentifier(), this.scope.declareName(e.id.name, 5, e.id.start), this.semicolon(), this.finishNode(e, "DeclareVariable");
	}
	flowParseDeclareModule(e) {
		this.scope.enter(0), this.match(130) ? e.id = super.parseExprAtom() : e.id = this.parseIdentifier();
		...
		let r = null, i = !1;
		return n.forEach((e) => {
			lt(e) ? (r === "CommonJS" && this.raise(P.AmbiguousDeclareModuleKind, e), r = "ES") : e.type === "DeclareModuleExports" && (i && this.raise(P.DuplicateDeclareModuleExports, e), r === "ES" && this.raise(P.AmbiguousDeclareModuleKind, e), r = "CommonJS", i = !0);
	...
	flowParseDeclareExportDeclaration(e, t) {
		...
		if (this.match(51) || this.match(2) || this.isContextual(125) || this.isContextual(126) || this.isContextual(127)) {
			...
			return t.type === "ExportNamedDeclaration" ? (t.default = !1, delete t.exportKind, this.castNodeTo(t, "DeclareExportDeclaration")) : this.castNodeTo(t, "DeclareExportAllDeclaration");
		}
		throw this.unexpected();
	}
	flowParseDeclareModuleExports(e) {
		return this.next(), this.expectContextual(107), e.typeAnnotation = this.flowParseTypeAnnotation(), this.semicolon(), this.finishNode(e, "DeclareModuleExports");
	}
	...
	flowParseInterfaceish(e, t) {
		if (e.id = this.flowParseRestrictedIdentifier(!t, !0), this.scope.declareName(e.id.name, t ? 17 : 8201, e.id.start), this.match(43) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.extends = [], this.eat(77)) do
			e.extends.push(this.flowParseInterfaceExtends());
		while (!t && this.eat(8));
		if (t) {
			let t = [], n = [];
			if (this.eatContextual(113)) do
				n.push(this.flowParseInterfaceExtends());
			while (this.eat(8));
			if (this.eatContextual(109)) do
				t.push(this.flowParseClassImplements());
			while (this.eat(8));
			e.implements = t, e.mixins = n;
		}
	...
	checkReservedType(e, t, n) {
		ct.has(e) && this.raise(n ? P.AssignReservedType : P.UnexpectedReservedType, t, { reservedType: e });
	}
	...
	flowParseRestrictedIdentifier(e, t) {
		let n = this.startNode(), r = this.flowParseRestrictedIdentifierName(e, t);
		return this.createIdentifier(n, r);
	}
	flowParseTypeAlias(e) {
		return e.id = this.flowParseRestrictedIdentifier(!1, !0), this.scope.declareName(e.id.name, 8201, e.id.start), this.match(43) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.right = this.flowParseTypeInitialiser(25), this.semicolon(), this.finishNode(e, "TypeAlias");
	}
	flowParseOpaqueType(e, t) {
		return this.expectContextual(126), e.id = this.flowParseRestrictedIdentifier(!0, !0), this.scope.declareName(e.id.name, 8201, e.id.start), this.match(43) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.supertype = null, this.match(10) && (e.supertype = this.flowParseTypeInitialiser(10)), e.impltype = null, t || (e.impltype = this.flowParseTypeInitialiser(25)), this.semicolon(), this.finishNode(e, t ? "DeclareOpaqueType" : "OpaqueType");
	}
	flowParseTypeParameterBound() {
		if (this.match(10) || this.isContextual(77)) {
			let e = this.startNode();
			return this.next(), e.typeAnnotation = this.flowParseType(), this.finishNode(e, "TypeAnnotation");
		}
	}
	...
	flowParseTypeParameterDeclaration() {
		...
		t.params = [], this.state.inType = !0, this.match(43) || this.match(138) ? this.next() : this.unexpected();
		let n = !1;
		do {
			let e = this.flowParseTypeParameter(n);
			t.params.push(e), e.default && (n = !0), this.match(44) || this.expect(8);
		} while (!this.match(44));
	...
	flowParseTypeParameterInstantiationCallOrNew() {
		...
		let e = this.startNode(), t = this.state.inType;
		for (e.params = [], this.state.inType = !0, this.expect(43); !this.match(44);) e.params.push(this.flowParseTypeOrImplicitInstantiation()), this.match(44) || this.expect(8);
		return this.expect(44), this.state.inType = t, this.finishNode(e, "TypeParameterInstantiation");
	}
	flowParseInterfaceType() {
		let e = this.startNode();
		if (this.expectContextual(125), e.extends = [], this.eat(77)) do
			e.extends.push(this.flowParseInterfaceExtends());
		while (this.eat(8));
	...
	flowParseObjectTypeIndexer(e, t, n) {
		return e.static = t, this.lookahead().type === 10 ? (e.id = this.parseIdentifier(!0), e.key = this.flowParseTypeInitialiser()) : (e.id = null, e.key = this.flowParseType()), this.expect(1), e.value = this.flowParseTypeInitialiser(), e.variance = n, this.finishNode(e, "ObjectTypeIndexer");
	}
	flowParseObjectTypeInternalSlot(e, t) {
		return e.static = t, e.id = this.parseIdentifier(!0), this.expect(1), this.expect(1), this.match(43) || this.match(6) ? (e.method = !0, e.optional = !1, e.value = this.flowParseObjectTypeMethodish(this.startNodeAtNode(e))) : (e.method = !1, this.eat(13) && (e.optional = !0), e.value = this.flowParseTypeInitialiser()), this.finishNode(e, "ObjectTypeInternalSlot");
	}
	flowParseObjectTypeMethodish(e) {
		for (e.params = [], e.rest = null, e.typeParameters = null, e.this = null, this.match(43) && (e.typeParameters = this.flowParseTypeParameterDeclaration()), this.expect(6), this.match(74) && (e.this = this.flowParseFunctionTypeParam(!0), e.this.name = null, this.match(7) || this.expect(8)); !this.match(7) && !this.match(17);) e.params.push(this.flowParseFunctionTypeParam(!1)), this.match(7) || this.expect(8);
		return this.eat(17) && (e.rest = this.flowParseFunctionTypeParam(!1)), this.expect(7), e.returnType = this.flowParseTypeInitialiser(), this.finishNode(e, "FunctionTypeAnnotation");
	}
	...
	flowParseObjectType({ allowStatic: e, allowExact: t, allowSpread: n, allowProto: r, allowInexact: i }) {
		...
		let s, c, l = !1;
		for (t && this.match(3) ? (this.expect(3), s = 5, c = !0) : (this.expect(2), s = 4, c = !1), o.exact = c; !this.match(s);) {
			let t = !1, a = null, s = null, u = this.startNode();
			if (r && this.isContextual(114)) {
				let t = this.lookahead();
				t.type !== 10 && t.type !== 13 && (this.next(), a = this.state.startLoc, e = !1);
			}
			if (e && this.isContextual(102)) {
				let e = this.lookahead();
				e.type !== 10 && e.type !== 13 && (this.next(), t = !0);
			}
			let d = this.flowParseVariance();
			if (this.eat(0)) a != null && this.unexpected(a), this.eat(0) ? (d && this.unexpected(d.start), o.internalSlots.push(this.flowParseObjectTypeInternalSlot(u, t))) : o.indexers.push(this.flowParseObjectTypeIndexer(u, t, d));
				...
				let e = "init";
				(this.isContextual(95) || this.isContextual(100)) && Ce(this.lookahead().type) && (e = this.state.value, this.next());
	...
	flowParseGenericType(e, t) {
		...
		return n.typeParameters = null, n.id = this.flowParseQualifiedTypeIdentifier(e, t), this.match(43) && (n.typeParameters = this.flowParseTypeParameterInstantiation()), this.finishNode(n, "GenericTypeAnnotation");
	}
	flowParseTypeofType() {
		let e = this.startNode();
		return this.expect(83), e.argument = this.flowParsePrimaryType(), this.finishNode(e, "TypeofTypeAnnotation");
	}
	flowParseTupleType() {
		let e = this.startNode();
		for (e.types = [], this.expect(0); this.state.pos < this.length && !this.match(1) && (e.types.push(this.flowParseType()), !this.match(1));) this.expect(8);
		return this.expect(1), this.finishNode(e, "TupleTypeAnnotation");
	}
	...
	flowParseFunctionTypeParams(e = []) {
		let t = null, n = null;
		for (this.match(74) && (n = this.flowParseFunctionTypeParam(!0), n.name = null, this.match(7) || this.expect(8)); !this.match(7) && !this.match(17);) e.push(this.flowParseFunctionTypeParam(!1)), this.match(7) || this.expect(8);
		return this.eat(17) && (t = this.flowParseFunctionTypeParam(!1)), {
			params: e,
			rest: t,
			_this: n
		};
	...
	flowParsePrimaryType() {
		...
		switch (this.state.type) {
			...
			case 43: {
				let e = this.startNode();
				return e.typeParameters = this.flowParseTypeParameterDeclaration(), this.expect(6), n = this.flowParseFunctionTypeParams(), e.params = n.params, e.rest = n.rest, e.this = n._this, this.expect(7), this.expect(15), e.returnType = this.flowParseType(), this.finishNode(e, "FunctionTypeAnnotation");
			}
			case 6: {
				let e = this.startNode();
				if (this.next(), !this.match(7) && !this.match(17)) if (D(this.state.type) || this.match(74)) {
					let e = this.lookahead().type;
					i = e !== 13 && e !== 10;
				} else i = !0;
				if (i) {
					if (this.state.noAnonFunctionType = !1, r = this.flowParseType(), this.state.noAnonFunctionType = a, this.state.noAnonFunctionType || !(this.match(8) || this.match(7) && this.lookahead().type === 15)) return this.expect(7), r;
					this.eat(8);
				}
				return n = r ? this.flowParseFunctionTypeParams([this.reinterpretTypeAsFunctionTypeParam(r)]) : this.flowParseFunctionTypeParams(), e.params = n.params, e.rest = n.rest, e.this = n._this, this.expect(7), this.expect(15), e.returnType = this.flowParseType(), e.typeParameters = null, this.finishNode(e, "FunctionTypeAnnotation");
			}
			case 130: return this.parseLiteral(this.state.value, "StringLiteralTypeAnnotation");
			case 81:
			case 82: return t.value = this.match(81), this.next(), this.finishNode(t, "BooleanLiteralTypeAnnotation");
			case 49:
				if (this.state.value === "-") {
			...
			case 84: return this.next(), this.finishNode(t, "VoidTypeAnnotation");
			case 80: return this.next(), this.finishNode(t, "NullLiteralTypeAnnotation");
			case 74: return this.next(), this.finishNode(t, "ThisTypeAnnotation");
			case 51: return this.next(), this.finishNode(t, "ExistsTypeAnnotation");
			case 83: return this.flowParseTypeofType();
			default: if (Oe(this.state.type)) {
				let e = A(this.state.type);
				return this.next(), super.createIdentifier(t, e);
			} else if (D(this.state.type)) return this.isContextual(125) ? this.flowParseInterfaceType() : this.flowIdentToTypeAnnotation(e, t, this.parseIdentifier());
		}
		throw this.unexpected();
	}
	flowParsePostfixType() {
		...
		for (; (this.match(0) || this.match(14)) && !this.canInsertSemicolon();) {
			let r = this.startNodeAt(e), i = this.eat(14);
			n ||= i, this.expect(0), !i && this.match(1) ? (r.elementType = t, this.next(), t = this.finishNode(r, "ArrayTypeAnnotation")) : (r.objectType = t, r.indexType = this.flowParseType(), this.expect(1), n ? (r.optional = i, t = this.finishNode(r, "OptionalIndexedAccessType")) : t = this.finishNode(r, "IndexedAccessType"));
		}
		return t;
	}
	flowParsePrefixType() {
		let e = this.startNode();
		return this.eat(13) ? (e.typeAnnotation = this.flowParsePrefixType(), this.finishNode(e, "NullableTypeAnnotation")) : this.flowParsePostfixType();
	}
	...
	flowParseIntersectionType() {
		...
		for (e.types = [t]; this.eat(41);) e.types.push(this.flowParseAnonFunctionWithoutParens());
	...
	flowParseUnionType() {
		...
		for (e.types = [t]; this.eat(39);) e.types.push(this.flowParseIntersectionType());
	...
	flowParseTypeAnnotatableIdentifier() {
		let e = this.startNode(), t = this.parseIdentifierName();
		return this.match(10) && (e.typeAnnotation = this.flowParseTypeAnnotation()), this.createIdentifier(e, t);
	}
	typeCastToParameter(e) {
		return e.expression.typeAnnotation = e.typeAnnotation, this.resetEndLocationFromNode(e.expression, e.typeAnnotation), e.expression;
	}
	flowParseVariance() {
		let e = null;
		return this.match(49) ? (e = this.startNode(), this.state.value === "+" ? e.kind = "plus" : e.kind = "minus", this.next(), this.finishNode(e, "Variance")) : e;
	}
	parseFunctionBody(e, t, n = !1) {
		if (t) {
	...
	parseFunctionBodyAndFinish(e, t, n = !1) {
		if (this.match(10)) {
			let n = this.startNode();
			t === "FunctionDeclaration" || t === "FunctionExpression" || t === "ArrowFunctionExpression" ? [n.typeAnnotation, e.predicate] = this.flowParseTypeAndPredicateInitialiser(!0) : n.typeAnnotation = this.flowParseTypeInitialiser(), e.returnType = n.typeAnnotation ? this.finishNode(n, "TypeAnnotation") : null;
		}
	...
	shouldParseExportDeclaration() {
		...
		return e === 122 || Ee(e) ? !this.state.containsEsc : super.shouldParseExportDeclaration();
	}
	isExportDefaultSpecifier() {
		let { type: e } = this.state;
		return e === 122 || Ee(e) ? this.state.containsEsc : super.isExportDefaultSpecifier();
	}
	...
	parseConditional(e, t, n) {
		...
		this.expect(13);
		let r = this.state.clone(), i = this.state.noArrowAt, a = this.startNodeAt(t), { consequent: o, failed: s } = this.tryParseConditionalConsequent(), c = this.getArrowLikeExpressions(o), l = c[0], u = c[1];
		if (s || u.length > 0) {
			let e = [...i];
			if (u.length > 0) {
	...
	tryParseConditionalConsequent() {
		...
		let e = this.parseMaybeAssignAllowIn(), t = !this.match(10);
	...
	getArrowLikeExpressions(e, t) {
		...
		return t ? (r.forEach((e) => this.finishArrowValidation(e)), [r, []]) : ft(r, (e) => e.params.every((e) => this.isAssignable(e, !0)));
	}
	...
	parseParenItem(e, t) {
		...
		if (this.eat(13) && (n.optional = !0, this.resetEndLocation(e)), this.match(10)) {
	...
	parseExportDeclaration(e) {
		if (this.isContextual(126)) {
			...
			return this.next(), this.match(2) ? (e.specifiers = this.parseExportSpecifiers(!0), super.parseExportFrom(e), null) : this.flowParseTypeAlias(t);
	...
	eatExportStar(e) {
		return super.eatExportStar(e) ? !0 : this.isContextual(126) && this.lookahead().type === 51 ? (e.exportKind = "type", this.next(), this.next(), !0) : !1;
	}
	...
	parseClassId(e, t, n) {
		if ((!t || n) && this.isContextual(109)) {
			e.id = null;
			return;
		}
		super.parseClassId(e, t, n), this.match(43) && (e.typeParameters = this.flowParseTypeParameterDeclaration());
	}
	...
	readIterator() {
		...
		(!this.isIterator(e) || !this.state.inType) && this.raise(g.InvalidIdentifier, this.state.curPosition(), { identifierName: t }), this.finishToken(128, t);
	}
	getTokenFromCode(e) {
		let t = this.input.charCodeAt(this.state.pos + 1);
		e === 123 && t === 124 ? this.finishOp(3, 2) : this.state.inType && (e === 62 || e === 60) ? this.finishOp(e === 62 ? 44 : 43, 1) : this.state.inType && e === 63 ? t === 46 ? this.finishOp(14, 2) : this.finishOp(13, 1) : tt(e, t, this.input.charCodeAt(this.state.pos + 2)) ? (this.state.pos += 2, this.readIterator()) : super.getTokenFromCode(e);
	}
	isAssignable(e, t) {
	...
	toAssignableListItem(e, t, n) {
		let r = e[t];
		r.type === "TypeCastExpression" && (e[t] = this.typeCastToParameter(r)), super.toAssignableListItem(e, t, n);
	}
	...
	parseArrayLike(e, t) {
		let n = super.parseArrayLike(e, t);
		return n.type === "ArrayExpression" && this.toReferencedList(n.elements), n;
	}
	isValidLVal(e, t, n, r) {
		return e === "TypeCastExpression" || super.isValidLVal(e, t, n, r);
	}
	parseClassProperty(e) {
		return this.match(10) && (e.typeAnnotation = this.flowParseTypeAnnotation()), super.parseClassProperty(e);
	}
	parseClassPrivateProperty(e) {
		return this.match(10) && (e.typeAnnotation = this.flowParseTypeAnnotation()), super.parseClassPrivateProperty(e);
	}
	isClassMethod() {
	...
	pushClassPrivateMethod(e, t, n, r) {
		t.variance && this.unexpected(t.variance.start), delete t.variance, this.match(43) && (t.typeParameters = this.flowParseTypeParameterDeclaration()), super.pushClassPrivateMethod(e, t, n, r);
	}
	flowParseClassImplements() {
		let e = this.startNode();
		return e.id = this.flowParseRestrictedIdentifier(!0), this.match(43) ? e.typeParameters = this.flowParseTypeParameterInstantiation() : e.typeParameters = null, this.finishNode(e, "ClassImplements");
	}
	parseClassSuper(e) {
		if (super.parseClassSuper(e), e.superClass && (this.match(43) || this.match(47)) && (e.superTypeArguments = this.flowParseTypeParameterInstantiationInExpression()), this.eatContextual(109)) {
			let t = e.implements = [];
			do
				t.push(this.flowParseClassImplements());
			while (this.eat(8));
	...
	parseObjPropValue(e, t, n, r, i, a, o) {
		...
		let s;
		this.match(43) && !a && (s = this.flowParseTypeParameterDeclaration(), this.match(6) || this.unexpected());
	...
	parseImportSpecifierLocal(e, t, n) {
		t.local = ut(e) ? this.flowParseRestrictedIdentifier(!0, !0) : this.parseIdentifier(), e.specifiers.push(this.finishImportSpecifier(t, n));
	}
	...
	applyImportPhase(e, t, n, r) {
		if (super.applyImportPhase(e, t, n, r), t) {
			if (!n && this.match(61)) return;
			e.exportKind = n === "type" ? n : "value";
		} else n === "type" && this.match(51) && this.unexpected(), e.importKind = n === "type" || n === "typeof" ? n : "value";
	}
	...
	parseFunctionParams(e, t) {
		let n = e.kind;
		n !== "get" && n !== "set" && this.match(43) && (e.typeParameters = this.flowParseTypeParameterDeclaration()), super.parseFunctionParams(e, t);
	}
	parseVarId(e, t) {
		super.parseVarId(e, t), this.match(10) && (e.id.typeAnnotation = this.flowParseTypeAnnotation(), this.resetEndLocation(e.id));
	}
	...
	parseMaybeAssign(e, t) {
		...
		if (r?.error || this.match(43)) {
			n ||= this.state.clone();
			let i, a = this.tryParse((n) => {
				i = this.flowParseTypeParameterDeclaration();
				let r = this.forwardNoArrowParamsConversionAt(i, () => {
					let n = super.parseMaybeAssign(e, t);
					return this.resetStartLocationFromNode(n, i), n;
				});
				r.extra?.parenthesized && n();
				let a = this.maybeUnwrapTypeCastExpression(r);
	...
	parseArrow(e) {
		if (this.match(10)) {
			let t = this.tryParse(() => {
				...
				let n = this.startNode();
				return [n.typeAnnotation, e.predicate] = this.flowParseTypeAndPredicateInitialiser(!0), this.state.noAnonFunctionType = t, this.canInsertSemicolon() && this.unexpected(), this.match(15) || this.unexpected(), n;
			});
	...
	parseSubscripts(e, t, n) {
		if (e.type === "Identifier" && e.name === "async" && this.state.noArrowAt.includes(t.index)) {
			...
			n.callee = e, n.arguments = super.parseCallExpressionArguments(), e = this.finishNode(n, "CallExpression");
	...
	parseSubscript(e, t, n, r) {
		if (this.match(14) && this.isLookaheadToken_lt()) {
			...
			return i.callee = e, i.typeArguments = this.flowParseTypeParameterInstantiationInExpression(), this.expect(6), i.arguments = this.parseCallExpressionArguments(), i.optional = !0, this.finishCallExpression(i, !0);
		} else if (!n && this.shouldParseTypes() && (this.match(43) || this.match(47))) {
			let n = this.startNodeAt(t);
			n.callee = e;
			let i = this.tryParse(() => (n.typeArguments = this.flowParseTypeParameterInstantiationCallOrNew(), this.expect(6), n.arguments = super.parseCallExpressionArguments(), r.optionalChainMember && (n.optional = !1), this.finishCallExpression(n, r.optionalChainMember)));
	...
	parseNewCallee(e) {
		...
		let t = null;
		this.shouldParseTypes() && this.match(43) && (t = this.tryParse(() => this.flowParseTypeParameterInstantiationCallOrNew()).node), e.typeArguments = t;
	}
	...
	flowEnumBody(e, t) {
		let n = t.name, r = t.start, i = this.flowEnumParseExplicitType({ enumName: n });
		this.expect(2);
		...
		switch (e.hasUnknownMembers = o, i) {
			case "boolean": return e.explicitType = !0, e.members = a.booleanMembers, this.expect(4), this.finishNode(e, "EnumBooleanBody");
			case "number": return e.explicitType = !0, e.members = a.numberMembers, this.expect(4), this.finishNode(e, "EnumNumberBody");
			case "string": return e.explicitType = !0, e.members = this.flowEnumStringMembers(a.stringMembers, a.defaultedMembers, { enumName: n }), this.expect(4), this.finishNode(e, "EnumStringBody");
			case "symbol": return e.members = a.defaultedMembers, this.expect(4), this.finishNode(e, "EnumSymbolBody");
			default: {
				let t = () => (e.members = [], this.expect(4), this.finishNode(e, "EnumStringBody"));
				e.explicitType = !1;
				let i = a.booleanMembers.length, o = a.numberMembers.length, s = a.stringMembers.length, c = a.defaultedMembers.length;
				if (!i && !o && !s && !c) return t();
				if (!i && !o) return e.members = this.flowEnumStringMembers(a.stringMembers, a.defaultedMembers, { enumName: n }), this.expect(4), this.finishNode(e, "EnumStringBody");
				if (!o && !s && i >= c) {
					for (let e of a.defaultedMembers) this.flowEnumErrorBooleanMemberNotInitialized(e.start, {
						enumName: n,
						memberName: e.id.name
					});
					return e.members = a.booleanMembers, this.expect(4), this.finishNode(e, "EnumBooleanBody");
				} else if (!i && !s && o >= c) {
					for (let e of a.defaultedMembers) this.flowEnumErrorNumberMemberNotInitialized(e.start, {
						enumName: n,
						memberName: e.id.name
					});
					return e.members = a.numberMembers, this.expect(4), this.finishNode(e, "EnumNumberBody");
				} else return this.raise(P.EnumInconsistentMemberValues, r, { enumName: n }), t();
			}
		}
	}
	...
	jsxParseOpeningElementAfterName(e) {
		return this.shouldParseTypes() && (this.match(43) || this.match(47)) && (e.typeArguments = this.flowParseTypeParameterInstantiationInExpression()), super.jsxParseOpeningElementAfterName(e);
	}
	isLookaheadToken_lt() {
	...
	reScan_lt_gt() {
		let { type: e } = this.state;
		e === 43 ? (--this.state.pos, this.readToken_lt()) : e === 44 && (--this.state.pos, this.readToken_gt());
	}
	reScan_lt() {
		let { type: e } = this.state;
		return e === 47 ? (this.state.pos -= 2, this.finishOp(43, 1), 43) : e;
	}
...
var bt = (e) => class extends e {
			...
			switch (n) {
				...
				case 123:
					if (this.state.pos === this.state.start) {
						n === 60 && this.state.canStartJSXElement ? (++this.state.pos, this.finishToken(138)) : super.getTokenFromCode(n);
						return;
					}
					e += this.input.slice(t, this.state.pos), this.finishToken(137, e);
					return;
				case 38:
	...
	jsxReadEntity() {
		...
		if (this.codePointAtPos(this.state.pos) === 35) {
			...
			n && (this.input.slice(e, this.state.pos), ++this.state.pos);
		}
	...
	jsxParseIdentifier() {
		let e = this.startNode();
		return this.match(136) ? e.name = this.state.value : Oe(this.state.type) ? e.name = A(this.state.type) : this.unexpected(), this.next(), this.finishNode(e, "JSXIdentifier");
	}
	...
	jsxParseOpeningElementAt(e) {
		...
		let t = this.startNodeAt(e);
		return t.name = this.jsxParseElementName(), this.jsxParseOpeningElementAfterName(t);
	}
	jsxParseOpeningElementAfterName(e) {
		let t = [];
		for (; !this.match(52) && !this.match(139);) t.push(this.jsxParseAttribute());
		return e.attributes = t, e.selfClosing = this.eat(52), this.expect(139), this.finishNode(e, "JSXOpeningElement");
	}
	jsxParseClosingElementAt(e) {
		...
		let t = this.startNodeAt(e);
		return t.name = this.jsxParseElementName(), this.expect(139), this.finishNode(t, "JSXClosingElement");
	}
	jsxParseElementAt(e) {
		...
		if (!r.selfClosing) {
			t: for (;;) switch (this.state.type) {
				case 138:
					if (e = this.state.startLoc, this.next(), this.eat(52)) {
						this.setLoc(e), i = this.jsxParseClosingElementAt(e);
						break t;
					}
	...
	parseExprAtom(e) {
		return this.match(138) ? this.jsxParseElement() : this.match(43) && this.input.charCodeAt(this.state.pos) !== 33 ? (this.replaceToken(138), this.jsxParseElement()) : super.parseExprAtom(e);
	}
	skipSpace() {
	...
	updateContext(e) {
		...
		} else this.state.canStartJSXElement = we(n);
	}
}, xt = class extends it {
	...
	importsStack = [];
	createScope(e) {
		return this.importsStack.push(/* @__PURE__ */ new Set()), new xt(e);
	}
	enter(e) {
	...
	declareName(e, t, n) {
		if (t & 4096) {
			this.hasImport(e, !0) && this.parser.raise(g.VarRedeclaration, n, { identifierName: e }), this.importsStack[this.importsStack.length - 1].add(e);
			return;
		}
	...
	isRedeclaredInScope(e, t, n) {
		...
		return (r & 2) > 0 ? n & 256 ? (n & 512) > 0 != (r & 4) > 0 : !0 : n & 128 && (r & 8) > 0 ? e.names.get(t) & 2 ? !!(n & 1) : !1 : n & 2 && (r & 1) > 0 ? !0 : super.isRedeclaredInScope(e, t, n);
	}
	checkLocalExport(e) {
		let { name: t } = e;
...
function z(e, t, n) {
	...
	r === null || r.start > n.start ? Et(e, n.comments) : wt(r, n.comments);
}
var Dt = class extends Ct {
	...
	finalizeComment(e) {
		let { comments: t } = e;
		if (e.leadingNode !== null || e.trailingNode !== null) e.leadingNode !== null && wt(e.leadingNode, t), e.trailingNode !== null && Tt(e.trailingNode, t);
		else {
	...
	init({ strictMode: e, sourceType: t, startIndex: n, startLine: r, startColumn: i }) {
		this.strict = e === !1 ? !1 : e === !0 || t === "module", this.startIndex = n, this.curLine = r, this.lineStart = -i, this.startLoc = this.endLoc = new c(r, i, n);
	}
	errors = [];
	noArrowAt = [];
	...
	tokensLength = 0;
	curPosition() {
		return new c(this.curLine, this.pos - this.lineStart, this.pos + this.startIndex);
	}
	clone() {
		let t = new e();
...
function Pt(e, t, n, r, i, a) {
	...
	switch (c) {
		...
		case 120: {
			let i;
			return {code: i, pos: t} = Ft(e, t, n, r, 2, !1, o, a), s(i === null ? null : String.fromCharCode(i));
		}
		case 117: {
			let i;
			return {code: i, pos: t} = Lt(e, t, n, r, o, a), s(i === null ? null : String.fromCodePoint(i));
		}
		case 116: return s("	");
		case 98: return s("\b");
		case 118: return s("\v");
...
function Ft(e, t, n, r, i, a, o, s) {
	let c = t, l;
	return {n: l, pos: t} = It(e, t, n, r, 16, i, a, !1, s, !o), l === null && (o ? s.invalidEscapeSequence(c, n, r) : t = c - 1), {
		code: l,
		pos: t
	};
}
function It(e, t, n, r, i, a, o, s, c, l) {
	let u = t, d = i === 16 ? At.hex : At.decBinOct, f = i === 16 ? jt.hex : i === 10 ? jt.dec : i === 8 ? jt.oct : jt.bin, p = !1, m = 0;
	for (let u = 0, ee = a ?? Infinity; u < ee; ++u) {
		let a = e.charCodeAt(t), u;
		if (a === 95 && s !== "bail") {
			let i = e.charCodeAt(t - 1), a = e.charCodeAt(t + 1);
			if (s) {
				if (Number.isNaN(a) || !f(a) || d.has(i) || d.has(a)) {
					if (l) return {
						n: null,
						pos: t
					};
		...
		if (u = a >= 97 ? a - 97 + 10 : a >= 65 ? a - 65 + 10 : kt(a) ? a - 48 : Infinity, u >= i) {
			if (u <= 9 && l) return {
				n: null,
				pos: t
			};
...
function Lt(e, t, n, r, i, a) {
	...
	if (o === 123) {
		if (++t, {code: s, pos: t} = Ft(e, t, n, r, e.indexOf("}", t) - t, !0, i, a), ++t, s !== null && s > 1114111) if (i) a.invalidCodePoint(t, n, r);
		else return {
			code: null,
			pos: t
		};
	} else ({code: s, pos: t} = Ft(e, t, n, r, 4, !1, i, a));
	return {
		code: s,
		pos: t
	};
...
var Rt = /* @__PURE__ */ new Set([
...
}, Bt, Vt = class extends Dt {
	isLookahead;
	tokens = [];
	constructor(e, t) {
		super(), this.state = new Ot(), this.state.init(e), this.input = t, this.length = t.length, this.comments = [], this.isLookahead = !1, (!Bt || Bt.length < (this.length + 1) * 2) && (Bt = new Uint32Array((this.length + 1) * 2)), this.locData = Bt;
	}
	setLoc(e) {
	...
	getLoc(e) {
		...
		return new c(this.locData[t * 2], this.locData[t * 2 + 1], e);
	}
	pushToken(e) {
		this.tokens.length = this.state.tokensLength, this.tokens.push(e), ++this.state.tokensLength;
	}
	next() {
		this.checkKeywordEscapes(), this.optionFlags & 512 && this.pushToken(new zt(this.state)), this.state.lastTokEndLoc = this.state.endLoc, this.state.lastTokStartLoc = this.state.startLoc, this.nextToken();
	}
	eat(e) {
	...
	nextTokenStartSince(e) {
		return _t.lastIndex = e, _t.test(this.input) ? _t.lastIndex : e;
	}
	lookaheadCharCode() {
	...
	nextTokenInLineStartSince(e) {
		return vt.lastIndex = e, vt.test(this.input) ? vt.lastIndex : e;
	}
	...
	skipBlockComment(e) {
		...
		if (r === -1) throw this.raise(g.UnterminatedComment, this.state.curPosition());
		for (this.state.pos = r + e.length, ht.lastIndex = n + 2; ht.test(this.input) && ht.lastIndex <= r;) ++this.state.curLine, this.state.lineStart = ht.lastIndex;
		...
		let i = {
			...
			loc: new l(t, this.state.curPosition())
		};
	...
	skipLineComment(e) {
		...
		if (this.state.pos < this.length) for (; !F(r) && ++this.state.pos < this.length;) r = this.input.charCodeAt(this.state.pos);
		if (this.isLookahead) return;
		let i = this.state.pos, a = {
			...
			loc: new l(n, this.state.curPosition())
		};
		...
		t: for (; this.state.pos < this.length;) {
			...
			switch (n) {
				...
				case 47:
					...
					break;
				default: if (yt(n)) ++this.state.pos;
				...
				} else if (n === 60 && !this.inModule && this.optionFlags & 16384) {
					let e = this.state.pos;
	...
	readToken_mult_modulo(e) {
		let t = e === 42 ? 51 : 50, n = 1, r = this.input.charCodeAt(this.state.pos + 1);
		e === 42 && r === 42 && (n++, r = this.input.charCodeAt(this.state.pos + 2), t = 53), r === 61 && !this.state.inType && (n++, t = e === 37 ? 29 : 26), this.finishOp(t, n);
	}
	readToken_pipe_amp(e) {
		let t = this.input.charCodeAt(this.state.pos + 1);
		if (t === e) {
	...
	readRegexp() {
		...
		for (;; ++i) {
			if (i >= this.length) throw this.raise(g.UnterminatedRegExp, u(e, 1));
			let t = this.input.charCodeAt(i);
			if (F(t)) throw this.raise(g.UnterminatedRegExp, u(e, 1));
			if (n) n = !1;
			else {
				if (t === 91) r = !0;
				else if (t === 93 && r) r = !1;
		...
		for (; i < this.length;) {
			...
			if (Rt.has(e)) e === 118 ? o.includes("u") && this.raise(g.IncompatibleRegExpUVFlags, s()) : e === 117 && o.includes("v") && this.raise(g.IncompatibleRegExpUVFlags, s()), o.includes(t) && this.raise(g.DuplicateRegExpFlags, s());
			else if (N(e) || e === 92) this.raise(g.MalformedRegExpFlags, s());
			else break;
			++i, o += t;
		}
		this.state.pos = i, this.finishToken(133, {
			pattern: a,
			flags: o
		});
	}
	readInt(e, t, n = !1, r = !0) {
		let { n: i, pos: a } = It(this.input, this.state.pos, this.state.lineStart, this.state.curLine, e, t, n, r, this.errorHandlers_readInt, !1);
	...
	readRadixNumber(e) {
		...
		if (i ?? this.raise(g.InvalidDigit, u(n, 2), { radix: e }), this.input.charCodeAt(this.state.pos) === 110 && (++this.state.pos, r = !0), M(this.codePointAtPos(this.state.pos))) throw this.raise(g.NumberIdentifier, this.state.curPosition());
		if (r) {
			let e = this.input.slice(t, this.state.pos).replace(/[_n]/g, "");
			this.finishToken(132, e);
			return;
		}
		this.finishToken(131, i);
	}
	readNumber(e) {
		let t = this.state.pos, n = this.state.curPosition(), r = !1, i = !1, a = !1;
		!e && this.readInt(10) === null && this.raise(g.InvalidNumber, this.state.curPosition());
		let s = this.state.pos - t >= 2 && this.input.charCodeAt(t) === 48;
		if (s) {
			let e = this.input.slice(t, this.state.pos);
			if (this.recordStrictModeErrors(g.StrictOctalLiteral, n), !this.state.strict) {
				let t = e.indexOf("_");
				t > 0 && this.raise(g.ZeroDigitNumericSeparator, u(n, t));
			}
			a = s && !/[89]/.test(e);
		}
		let c = this.input.charCodeAt(this.state.pos);
		c === 46 && !a && (++this.state.pos, this.readInt(10), r = !0, c = this.input.charCodeAt(this.state.pos)), (c === 69 || c === 101) && !a && (c = this.input.charCodeAt(++this.state.pos), (c === 43 || c === 45) && ++this.state.pos, this.readInt(10) === null && this.raise(g.InvalidOrMissingExponent, n), r = !0, c = this.input.charCodeAt(this.state.pos));
		let l = o(0, this.input.slice(t, this.state.pos), "_", "");
		if (c === 110 && ((r || s) && this.raise(g.InvalidBigIntLiteral, n), ++this.state.pos, i = !0), M(this.codePointAtPos(this.state.pos))) throw this.raise(g.NumberIdentifier, this.state.curPosition());
		if (i) {
			this.finishToken(132, l);
			return;
		}
		let d = a ? parseInt(l, 8) : parseFloat(l);
		this.finishToken(131, d);
	}
	readCodePoint(e) {
		let { code: t, pos: n } = Lt(this.input, this.state.pos, this.state.lineStart, this.state.curLine, e, this.errorHandlers_readCodePoint);
		return this.state.pos = n, t;
	}
	readString(e) {
		let { str: t, pos: n, curLine: r, lineStart: i } = Mt(e === 34 ? "double" : "single", this.input, this.state.pos + 1, this.state.lineStart, this.state.curLine, this.errorHandlers_readStringContents_string);
	...
	readTemplateToken() {
		let e = this.input[this.state.pos], { str: t, firstInvalidLoc: n, pos: r, curLine: i, lineStart: a } = Mt("template", this.input, this.state.pos + 1, this.state.lineStart, this.state.curLine, this.errorHandlers_readStringContents_template);
		this.state.pos = r + 1, this.state.lineStart = a, this.state.curLine = i, n && (this.state.firstInvalidTemplateEscapePos = new c(n.curLine, n.pos - n.lineStart, this.sourceToOffsetPos(n.pos))), this.input.codePointAt(r) === 96 ? this.finishToken(20, n ? null : e + t + "`") : (this.state.pos++, this.finishToken(21, n ? null : e + t + "${"));
	}
	...
	readWord1(e) {
		...
		for (e !== void 0 && (this.state.pos += e <= 65535 ? 1 : 2); this.state.pos < this.length;) {
			...
			if (N(e)) this.state.pos += e <= 65535 ? 1 : 2;
				...
				a !== null && (i(a) || this.raise(g.EscapedCharNotAnIdentifier, e), t += String.fromCodePoint(a)), r = this.state.pos;
			} else break;
		}
		return t + this.input.slice(r, this.state.pos);
	}
	readWord(e) {
		let t = this.readWord1(e), n = me.get(t);
		n === void 0 ? this.finishToken(128, t) : this.finishToken(n, A(n));
	}
	checkKeywordEscapes() {
		let { type: e } = this.state;
		Oe(e) && this.state.containsEsc && this.raise(g.InvalidEscapedReservedWord, this.state.startLoc, { reservedWord: A(e) });
	}
	raise(e, t, n = {}) {
		let r = t instanceof c ? t : typeof t == "number" ? this.getLoc(t) : this.optionFlags & 256 ? t.loc.start : this.getLoc(t.start), i = e(r, t instanceof c ? r.index : typeof t == "number" ? t : t.start, n);
		if (!(this.optionFlags & 4096)) throw i;
		return this.isLookahead || this.state.errors.push(i), i;
	}
	raiseOverwrite(e, t, n = {}) {
		let r = t instanceof c ? t : this.optionFlags & 256 ? t.loc.start : this.getLoc(t.start), i = t instanceof c ? r.index : t.start, a = this.state.errors;
		for (let t = a.length - 1; t >= 0; t--) {
			let o = a[t];
			if (o.pos === i) return a[t] = e(r, i, n);
			if (o.pos < i) break;
		}
		return this.raise(e, r, n);
	}
	updateContext(e) {}
	unexpected(e, t) {
	...
	exit() {
		...
		for (let [n, r] of Array.from(e.undefinedPrivateNames)) t ? t.undefinedPrivateNames.has(n) || t.undefinedPrivateNames.set(n, r) : this.parser.raise(g.InvalidPrivateFieldResolution, r, { identifierName: n });
	}
	declarePrivateName(e, t, n) {
		...
		o && this.parser.raise(g.PrivateNameRedeclaration, n, { identifierName: e }), r.add(e), a.delete(e);
	}
	usePrivateName(e, t) {
		let n;
	...
	recordParameterInitializerError(e, t) {
		let { stack: n } = this, r = n.length - 1, i = n[r];
		for (; !i.isCertainlyParameterDeclaration();) {
			if (i.canBeArrowParameterDeclaration()) i.recordDeclarationError(e, t);
			else return;
			i = n[--r];
		}
	...
	recordArrowParameterBindingError(e, t) {
		let { stack: n } = this, r = n[n.length - 1], i = t.start;
	...
	recordAsyncArrowParametersError(e) {
		...
		for (; r.canBeArrowParameterDeclaration();) r.type === 2 && r.recordDeclarationError(g.AwaitBindingIdentifier, e), r = t[--n];
	}
	validateAsPattern() {
		...
		t.canBeArrowParameterDeclaration() && t.iterateErrors((t, n) => {
			...
			for (; i.canBeArrowParameterDeclaration();) i.clearDeclarationError(n), i = e[--r];
		});
	}
};
function qt() {
...
var $t = class extends Vt {
	...
	hasPrecedingLineBreak() {
		return gt(this.input, this.offsetToSourcePos(this.state.lastTokEndLoc.index), this.state.start);
	}
	hasFollowingLineBreak() {
		return gt(this.input, this.state.end, this.nextTokenStart());
	}
	isLineTerminator() {
		return this.eat(9) || this.canInsertSemicolon();
	}
	semicolon(e = !0) {
		(e ? this.isLineTerminator() : this.eat(9)) || this.raise(g.MissingSemicolon, this.state.lastTokEndLoc);
	}
	expect(e, t) {
	...
	checkExpressionErrors(e, t) {
		if (!e) return !1;
		let { shorthandAssignLoc: n, doubleProtoLoc: r, privateKeyLoc: i, optionalParametersLoc: a, voidPatternLoc: o } = e, s = !!n || !!r || !!a || !!i || !!o;
		if (!t) return s;
	...
	initializeScopes(e = this.options.sourceType === "module") {
		...
		this.prodParam = new Zt();
		let s = this.classScope;
		this.classScope = new Ut(this);
		let c = this.expressionScope;
		return this.expressionScope = new Kt(this), () => {
	...
	enterInitialScopes() {
		...
		let n = t ? 514 : 1;
		this.optionFlags & 4 && (n |= 512), this.optionFlags & 16 && (n |= 48), this.scope.enter(n);
	}
	...
	constructor(e, t, n, r) {
		this.start = n, this.end = 0, r !== void 0 && (this.loc = new l(r)), e & 128 && (this.range = [n, 0]), r !== void 0 && t && (this.loc.filename = t);
	}
	type = "";
}, tn = V.prototype, nn = class extends $t {
	createPosition(e) {
		return e;
	}
	startNode() {
	...
	finishNodeAt(e, t, n) {
		e.type = t, e.end = n.index;
		let { optionFlags: r } = this;
		return r & 256 && (e.loc.end = this.createPosition(n)), r & 128 && (e.range[1] = n.index), r & 8192 && this.processComment(e), e;
	}
	finishNodeAtNode(e, t, n) {
		e.type = t, e.end = n.end;
		let { optionFlags: r } = this;
		return r & 256 && (e.loc.end = n.loc.end), r & 128 && (e.range[1] = e.end), r & 8192 && this.processComment(e), e;
	}
	resetStartLocation(e, t) {
		e.start = t.index;
		let { optionFlags: n } = this;
		n & 256 && (e.loc.start = this.createPosition(t)), n & 128 && (e.range[0] = t.index);
	}
	resetEndLocation(e, t = this.state.lastTokEndLoc) {
		e.end = t.index;
		let { optionFlags: n } = this;
		n & 256 && (e.loc.end = this.createPosition(t)), n & 128 && (e.range[1] = t.index);
	}
	resetStartLocationFromNode(e, t) {
		e.start = t.start;
		let { optionFlags: n } = this;
		n & 256 && (e.loc.start = t.loc.start), n & 128 && (e.range[0] = t.start);
	}
	resetEndLocationFromNode(e, t) {
		e.end = t.end;
		let { optionFlags: n } = this;
		n & 256 && (e.loc.end = t.loc.end), n & 128 && (e.range[1] = t.end);
	}
	castNodeTo(e, t) {
		return e.type = t, e;
	}
	cloneIdentifier(e) {
		let { type: t, start: n, end: r, loc: i, range: a, name: o } = e, s = Object.create(tn);
		return s.type = t, s.start = n, s.end = r, s.loc = i, s.range = a, s.name = o, e.extra && (s.extra = e.extra), s;
	}
	cloneStringLiteral(e) {
		let { type: t, start: n, end: r, loc: i, range: a, extra: o } = e, s = Object.create(tn);
		return s.type = t, s.start = n, s.end = r, s.loc = i, s.range = a, s.extra = o, s.value = e.value, s;
	}
}, rn = (e) => e.type === "ParenthesizedExpression" ? rn(e.expression) : e, an = class extends nn {
	toAssignable(e, t = !1) {
		let n;
		switch ((e.type === "ParenthesizedExpression" || e.extra?.parenthesized) && (n = rn(e), t ? n.type === "Identifier" ? this.expressionScope.recordArrowParameterBindingError(g.InvalidParenthesizedAssignment, e) : n.type !== "CallExpression" && n.type !== "MemberExpression" && !this.isOptionalMemberExpression(n) && this.raise(g.InvalidParenthesizedAssignment, e) : this.raise(g.InvalidParenthesizedAssignment, e)), e.type) {
			case "Identifier":
			case "ObjectPattern":
			case "ArrayPattern":
			...
			case "ObjectExpression":
				...
				for (let n = 0, r = e.properties.length, i = r - 1; n < r; n++) {
					let r = e.properties[n], a = n === i;
					this.toAssignableObjectExpressionProp(r, a, t), a && r.type === "RestElement" && e.extra?.trailingCommaLoc && this.raise(g.RestTrailingComma, e.extra.trailingCommaLoc);
				}
				break;
			case "ObjectProperty": {
				let { key: n, value: r } = e;
			...
			case "AssignmentExpression":
				e.operator !== "=" && this.raise(g.MissingEqInAssignment, this.optionFlags & 256 ? e.left.loc.end : e.left), this.castNodeTo(e, "AssignmentPattern"), delete e.operator, e.left.type === "VoidPattern" && this.raise(g.VoidPatternInitializer, e.left), this.toAssignable(e.left, t);
				break;
	...
	toAssignableObjectExpressionProp(e, t, n) {
		if (e.type === "ObjectMethod") this.raise(e.kind === "get" || e.kind === "set" ? g.PatternHasAccessor : g.PatternHasMethod, e.key);
		else if (e.type === "SpreadElement") {
			this.castNodeTo(e, "RestElement");
			let r = e.argument;
			this.checkToRestConversion(r, !1), this.toAssignable(r, n), t || this.raise(g.RestTrailingComma, e);
	...
	toAssignableList(e, t, n) {
		...
		for (let i = 0; i <= r; i++) {
			let a = e[i];
			a && (this.toAssignableListItem(e, i, n), a.type === "RestElement" && (i < r ? this.raise(g.RestTrailingComma, a) : t && this.raise(g.RestTrailingComma, t)));
		}
	}
	toAssignableListItem(e, t, n) {
		let r = e[t];
	...
	parseRestBinding() {
		...
		return t.type === "VoidPattern" && this.raise(g.UnexpectedVoidPattern, t), e.argument = t, this.finishNode(e, "RestElement");
	}
	parseBindingAtom() {
		switch (this.state.type) {
			case 0: {
	...
	parseBindingList(e, t, n) {
		let r = n & 1, i = [], a = !0;
		for (; !this.eat(e);) if (a ? a = !1 : this.expect(8), r && this.match(8)) i.push(null);
		else {
			if (this.eat(e)) break;
			if (this.match(17)) {
				let r = this.parseRestBinding();
				if (n & 2 && (r = this.parseFunctionParamType(r)), i.push(r), !this.checkCommaAfterRest(t)) {
					this.expect(e);
					break;
				}
			} else {
				let e = [];
				if (n & 2) for (this.match(22) && this.hasPlugin("decorators") && this.raise(g.UnsupportedParameterDecorator, this.state.startLoc); this.match(22);) e.push(this.parseDecorator());
	...
	parseBindingRestProperty(e) {
		return this.next(), this.hasPlugin("discardBinding") && this.match(84) ? (e.argument = this.parseVoidPattern(null), this.raise(g.UnexpectedVoidPattern, e.argument)) : e.argument = this.parseIdentifier(), this.checkCommaAfterRest(125), this.finishNode(e, "RestElement");
	}
	parseBindingProperty() {
		let { type: e, startLoc: t } = this.state;
		if (e === 17) return this.parseBindingRestProperty(this.startNode());
		let n = this.startNode();
		return e === 134 ? (this.expectPlugin("destructuringPrivate", t), this.classScope.usePrivateName(this.state.value, t), n.key = this.parsePrivateName()) : this.parsePropertyName(n), n.method = !1, this.parseObjPropValue(n, t, !1, !1, !0, !1);
	}
	parseBindingElement(e, t) {
		let { startLoc: n } = this.state, r = this.parseMaybeDefault();
		return e & 2 && this.parseFunctionParamType(r), t.length && (r.decorators = t, this.resetStartLocationFromNode(r, t[0])), this.parseMaybeDefault(n, r);
	}
	parseFunctionParamType(e) {
		return e;
	}
	parseMaybeDefault(e, t) {
		if (e ??= this.state.startLoc, t ??= this.parseBindingAtom(), !this.eat(25)) return t;
		let n = this.startNodeAt(e);
		return t.type === "VoidPattern" && this.raise(g.VoidPatternInitializer, t), n.left = t, n.right = this.parseMaybeAssignAllowIn(), this.finishNode(n, "AssignmentPattern");
	}
	isValidLVal(e, t, n, r) {
		switch (e) {
	...
	checkLVal(e, t, n = 64, r = !1, i = !1, a = !1, o = !1) {
		let s = e.type;
		if (this.isObjectMethod(e)) return;
		let c = this.isOptionalMemberExpression(e);
		if (c || s === "MemberExpression") {
			c && (this.expectPlugin("optionalChainingAssign", e.start), t.type !== "AssignmentExpression" && this.raise(g.InvalidLhsOptionalChaining, e, { ancestor: t })), n !== 64 && this.raise(g.InvalidPropertyBindingPattern, e);
			return;
		}
		if (s === "Identifier") {
			this.checkIdentifier(e, n, i);
			let { name: t } = e;
			r && (r.has(t) ? this.raise(g.ParamDupe, e) : r.add(t));
			return;
		} else s === "VoidPattern" && t.type === "CatchClause" && this.raise(g.VoidPatternCatchClauseParam, e);
		let l = rn(e);
		...
		if (u === !0) return;
		if (u === !1) {
			let r = n === 64 ? g.InvalidLhs : g.InvalidLhsBinding;
			this.raise(r, e, { ancestor: t });
			return;
		}
		let d, f;
		typeof u == "string" ? (d = u, f = s === "ParenthesizedExpression") : [d, f] = u;
		let p = s === "ArrayPattern" || s === "ObjectPattern" ? { type: s } : t, m = e[d];
		if (Array.isArray(m)) for (let e of m) e && this.checkLVal(e, p, n, r, i, f, !0);
		else m && this.checkLVal(m, p, n, r, i, f, o);
	}
	checkIdentifier(e, t, n = !1) {
		this.state.strict && (n ? $e(e.name, this.inModule) : Qe(e.name)) && (t === 64 ? this.raise(g.StrictEvalArguments, e, { referenceName: e.name }) : this.raise(g.StrictEvalArgumentsBinding, e, { bindingName: e.name })), t & 8192 && e.name === "let" && this.raise(g.LetInLexicalBinding, e), t & 64 || this.declareNameFromIdentifier(e, t);
	}
	...
	checkToRestConversion(e, t) {
		switch (e.type) {
			...
			default: this.raise(g.InvalidRestAssignmentPattern, e);
		}
	}
	...
	checkProto(e, t, n) {
		...
		let r = e.key;
		return (r.type === "Identifier" ? r.name : r.value) === "__proto__" ? (t && (n ? n.doubleProtoLoc === null && (n.doubleProtoLoc = this.getLoc(r.start)) : this.raise(g.DuplicateProto, r)), !0) : t;
	}
	...
	getExpression() {
		...
		return this.finalizeRemainingComments(), e.comments = this.comments, e.errors = this.state.errors, this.optionFlags & 512 && (e.tokens = dn(this.tokens)), e;
	}
	parseExpression(e, t) {
	...
	parseExpressionBase(e) {
		...
		if (this.match(8)) {
			...
			for (r.expressions = [n]; this.eat(8);) r.expressions.push(this.parseMaybeAssign(e));
	...
	parseMaybeAssign(e, t) {
		let n = this.state.startLoc, r = this.isContextual(104);
		...
		let i;
		e ? i = !1 : (e = new en(), i = !0), this.state.canStartArrow = !0;
		let a = this.parseMaybeConditional(e);
		if (t && (a = t.call(this, a, n)), Te(this.state.type)) {
	...
	parseMaybeConditional(e) {
		let t = this.state.startLoc, n = this.parseExprOps(e);
		return this.shouldExitDescending(n) ? n : this.parseConditional(n, t, e);
	}
	parseConditional(e, t, n) {
		if (this.eat(13)) {
			let n = this.startNodeAt(t);
			return n.test = e, n.consequent = this.parseMaybeAssignAllowIn(), this.expect(10), n.alternate = this.parseMaybeAssign(), this.finishNode(n, "ConditionalExpression");
		}
		return e;
	}
	...
	parseExprOps(e) {
		let t = this.state.startLoc, n = this.parseMaybeUnaryOrPrivate(e);
		return this.shouldExitDescending(n) ? n : (this.state.canStartArrow = !1, this.parseExprOp(n, t, -1));
	}
	parseExprOp(e, t, n) {
		if (this.isPrivateName(e)) {
			let r = this.getPrivateNameSV(e);
			(n >= Pe(54) || !this.prodParam.hasIn || !this.match(54)) && this.raise(g.PrivateInExpectedIn, t, { identifierName: r }), this.classScope.usePrivateName(r, t);
		}
		let r = this.state.type;
		if (ke(r) && (this.prodParam.hasIn || !this.match(54))) {
			let i = Pe(r);
			if (i > n) {
				...
				s && (i = Pe(38)), this.next(), a.right = this.parseExprOpRightExpr(r, i);
	...
	parseExprOpBaseRightExpr(e, t) {
		...
		return this.parseExprOp(this.parseMaybeUnaryOrPrivate(), n, Fe(e) ? t - 1 : t);
	}
	parseHackPipeBody() {
		let { startLoc: e } = this.state, t = this.parseMaybeAssign();
		return re.has(t.type) && !t.extra?.parenthesized && this.raise(g.PipeUnparenthesizedBody, e, { type: t.type }), this.topicReferenceWasUsedInCurrentContext() || this.raise(g.PipeTopicUnused, e), t;
	}
	checkExponentialAfterUnary(e) {
		this.match(53) && this.raise(g.UnexpectedTokenUnaryExponentiation, e.argument);
	}
	parseMaybeUnary(e, t) {
		let n = this.state.startLoc, r = this.isContextual(92);
		...
		if (je(this.state.type)) {
			...
			if (this.next(), a.argument = this.parseMaybeUnary(null, !0), this.checkExpressionErrors(e, !0), this.state.strict && n) {
				let e = a.argument;
				e.type === "Identifier" ? this.raise(g.StrictDelete, a) : this.hasPropertyAsPrivateName(e) && this.raise(g.DeletePrivateField, a);
			}
	...
	parseUpdate(e, t, n) {
		...
		for (; Ae(this.state.type) && !this.canInsertSemicolon();) {
	...
	parseExprSubscripts(e) {
		...
		this.setLoc(t);
		let n = this.parseExprAtom(e);
		return this.shouldExitDescending(n) ? n : this.parseSubscripts(n, t);
	}
	parseSubscripts(e, t, n) {
		let r = {
	...
	parseSubscript(e, t, n, r) {
		...
		if (Ie(i)) return this.parseTaggedTemplateExpression(e, t, r);
		let a = !1;
		if (i === 14) {
		...
		if (!n && this.match(6)) return this.parseCoverCallAndAsyncArrowHead(e, t, r, a);
		{
			let n = this.eat(0);
			return n || a || this.eat(12) ? this.parseMember(e, t, r, n, a) : this.stopParseSubscript(e, r);
		}
	}
	stopParseSubscript(e, t) {
		return t.stop = !0, e;
	...
	parseMember(e, t, n, r, i) {
		let a = this.startNodeAt(t);
		return a.object = e, a.computed = r, r ? (a.property = this.parseExpression(), this.expect(1)) : this.match(134) ? (e.type === "Super" && this.raise(g.SuperPrivateField, t), this.classScope.usePrivateName(this.state.value, this.state.startLoc), a.property = this.parsePrivateName()) : a.property = this.parseIdentifier(!0), n.optionalChainMember ? (a.optional = i, this.finishNode(a, "OptionalMemberExpression")) : this.finishNode(a, "MemberExpression");
	}
	parseBind(e, t, n) {
		let r = this.startNodeAt(t);
		r.object = e, this.next();
		let i = this.match(79), a = this.parseNoCallExpr();
		if (a.type === "Super" || i && a.type === "ImportExpression" || a.type === "Import") throw this.raise(g.UnsupportedBindRHS, a);
		return r.callee = a, n.stop = !0, this.parseSubscripts(this.finishNode(r, "BindExpression"), t, !1);
	}
	parseCoverCallAndAsyncArrowHead(e, t, n, r) {
		...
		o && (this.expressionScope.enter(Yt()), i = new en()), s && (a.optional = r), r ? a.arguments = this.parseCallExpressionArguments() : a.arguments = this.parseCallExpressionArguments(e.type !== "Super", a, i);
	...
	parseTaggedTemplateExpression(e, t, n) {
		let r = this.startNodeAt(t);
		return r.tag = e, r.quasi = this.parseTemplate(!0), n.optionalChainMember && this.raise(g.OptionalChainingNoTemplate, t), this.finishNode(r, "TaggedTemplateExpression");
	}
	...
	finishCallExpression(e, t) {
		if (e.callee.type === "Import") if (e.arguments.length === 0 || e.arguments.length > 2) this.raise(g.ImportCallArity, e);
		else for (let t of e.arguments) t.type === "SpreadElement" && this.raise(g.ImportCallSpreadArgument, t);
	...
	parseCallExpressionArguments(e, t, n) {
		...
		for (; !this.eat(7);) {
			...
			r.push(this.parseExprListItem(7, !1, n, e));
		}
		return r;
	}
	shouldParseAsyncArrow() {
	...
	parseAsyncArrowFromCallExpression(e, t) {
		return this.resetPreviousNodeTrailingComments(t), this.expect(15), this.parseArrowExpression(e, t.arguments, !0, t.extra?.trailingCommaLoc), t.innerComments && Et(e, t.innerComments), t.callee.trailingComments && Et(e, t.callee.trailingComments), e;
	}
	parseNoCallExpr() {
		let e = this.state.startLoc;
	...
	parseExprAtom(e) {
		...
		switch (r) {
			...
			case 79: return t = this.startNode(), this.next(), this.match(12) ? this.parseImportMetaPropertyOrPhaseCall(t) : this.match(6) ? this.optionFlags & 1024 ? this.parseImportCall(t) : this.finishNode(t, "Import") : (this.raise(g.UnsupportedImport, this.state.lastTokStartLoc), this.finishNode(t, "Import"));
			...
			case 22: n = this.parseDecorators();
			case 76: return this.parseClass(this.maybeTakeDecorators(n, this.startNode()), !1);
			...
			case 134: return this.raise(g.PrivateInExpectedIn, this.state.startLoc, { identifierName: this.state.value }), this.parsePrivateName();
	...
	parseTopicReferenceThenEqualsSign(e, t) {
		...
		if (n) return this.state.type = e, this.state.value = t, this.state.pos--, this.state.end--, this.state.endLoc = u(this.state.endLoc, -1), this.parseTopicReference(n);
		throw this.unexpected();
	}
	...
	testTopicReferenceConfiguration(e, t, n) {
		if (e === "hack") return this.hasPlugin(["pipelineOperator", { topicToken: A(n) }]);
		throw this.raise(g.PipeTopicRequiresHackPipes, t);
	}
	parseAsyncArrowUnaryFunction(e) {
		this.prodParam.enter(Qt(!0, this.prodParam.hasYield));
		let t = [this.parseIdentifier()];
	...
	parseSuper() {
		let e = this.startNode();
		return this.next(), this.match(6) && !this.scope.allowDirectSuper ? this.raise(g.SuperNotAllowed, e) : this.scope.allowSuper || this.raise(g.UnexpectedSuper, e), !this.match(6) && !this.match(0) && !this.match(12) && this.raise(g.UnsupportedSuper, e), this.finishNode(e, "Super");
	}
	parsePrivateName() {
		let e = this.startNode(), t = this.startNodeAt(u(this.state.startLoc, 1)), n = this.state.value;
	...
	parseMetaProperty(e, t, n) {
		...
		return e.property = this.parseIdentifier(!0), (e.property.name !== n || r) && this.raise(g.UnsupportedMetaProperty, e.property, {
			target: t.name,
	...
	parseImportMetaPropertyOrPhaseCall(e) {
		if (this.next(), this.isContextual(101) || this.isContextual(93)) {
			...
			return this.isContextual(97) && (this.inModule || this.raise(g.ImportMetaOutsideModule, t), this.sawUnambiguousESM = !0), this.parseMetaProperty(e, t, "meta");
		}
	}
	...
	parseParenAndDistinguishExpression(e) {
		...
		this.next(), this.expressionScope.enter(Jt());
		let r = this.state.startLoc, i = [], a = new en(), o = !0, s, c;
		for (; !this.match(7);) {
			if (o) o = !1;
			...
			if (this.match(17)) {
				let e = this.state.startLoc;
				if (s = this.state.startLoc, i.push(this.parseParenItem(this.parseRestBinding(), e)), !this.checkCommaAfterRest(41)) break;
			} else i.push(this.parseMaybeAssignAllowInOrVoidPattern(7, a, this.parseParenItem));
		}
		let l = this.state.lastTokEndLoc;
		this.expect(7);
		let u = this.startNodeAt(t);
		return e && this.shouldParseArrow(i) && (u = this.parseArrow(u)) ? (this.checkDestructuringPrivate(a), this.expressionScope.validateAsPattern(), this.expressionScope.exit(), this.parseArrowExpression(u, i, !1), u) : (this.expressionScope.exit(), i.length || this.unexpected(this.state.lastTokStartLoc), c && this.unexpected(c), s && this.unexpected(s), this.checkExpressionErrors(a, !0), this.toReferencedList(i, !0), i.length > 1 ? (n = this.startNodeAt(r), n.expressions = i, this.finishNode(n, "SequenceExpression"), this.resetEndLocation(n, l)) : n = i[0], this.wrapParenthesis(t, n));
	}
	wrapParenthesis(e, t) {
	...
	parseNewOrNewTarget() {
		...
		if (this.next(), this.match(12)) {
			...
			return this.scope.allowNewTarget || this.raise(g.UnexpectedNewTarget, n), n;
		}
	...
	parseNewCallee(e) {
		let t = this.match(79), n = this.parseNoCallExpr();
		e.callee = n, t && n.type === "ImportExpression" && this.raise(g.ImportCallNotNewExpression, n, n), n.type === "Import" && this.raise(g.ImportCallNotNewExpression, n), n.type === "Super" && this.raise(g.SuperCallNotNewExpression, n);
	}
	parseTemplateElement(e) {
		let { start: t, startLoc: n, end: r, value: i } = this.state, a = t + 1, o = this.startNodeAt(u(n, 1));
		i === null && (e || this.raise(g.InvalidEscapeSequenceTemplate, u(this.state.firstInvalidTemplateEscapePos, 1)));
		let s = this.match(20), c = s ? -1 : -2, l = r + c;
		o.value = {
			raw: this.input.slice(a, l).replace(/\r\n?/g, "\n"),
			cooked: i === null ? null : i.slice(1, c)
		}, o.tail = s, this.next();
		let d = this.finishNode(o, "TemplateElement");
		return this.resetEndLocation(d, u(this.state.lastTokEndLoc, c)), d;
	}
	parseTemplate(e) {
	...
	parseObjectLike(e, t, n) {
		let r = !1, i = !0, a = this.startNode();
		for (a.properties = [], this.next(); !this.match(e);) {
			if (i) i = !1;
			...
			let o;
			t ? o = this.parseBindingProperty() : (o = this.parsePropertyDefinition(n), r = this.checkProto(o, r, n)), a.properties.push(o);
		}
		this.next();
		let o = t ? "ObjectPattern" : "ObjectExpression";
		return this.finishNode(a, o);
	}
	...
	parsePropertyDefinition(e) {
		let t = [];
		if (this.match(22)) for (this.hasPlugin("decorators") && this.raise(g.UnsupportedPropertyDecorator, this.state.startLoc); this.match(22);) t.push(this.parseDecorator());
		let n = this.startNode(), r = !1, i = !1, a;
		if (this.match(17)) return t.length && this.unexpected(), this.parseSpread();
		t.length && (n.decorators = t), n.method = !1, e && (a = this.state.startLoc);
		let o = this.eat(51);
		...
		if (this.parsePropertyName(n, e), !o && !s && this.maybeAsyncOrAccessorProp(n)) {
			...
			t === "async" && !this.hasPrecedingLineBreak() && (r = !0, this.resetPreviousNodeTrailingComments(e), o = this.eat(51), this.parsePropertyName(n)), (t === "get" || t === "set") && (i = !0, this.resetPreviousNodeTrailingComments(e), n.kind = t, this.match(51) && (o = !0, this.raise(g.AccessorIsGenerator, this.state.curPosition(), { kind: t }), this.next()), this.parsePropertyName(n));
		}
	...
	checkGetterSetterParams(e) {
		...
		n.length !== t && this.raise(e.kind === "get" ? g.BadGetterArity : g.BadSetterArity, e), e.kind === "set" && n[n.length - 1]?.type === "RestElement" && this.raise(g.BadSetterRestParameter, e);
	}
	parseObjectMethod(e, t, n, r, i) {
		...
		if (n || t || this.match(6)) return r && this.unexpected(), e.kind = "method", e.method = !0, this.parseMethod(e, t, n, !1, !1, "ObjectMethod");
	}
	parseObjectProperty(e, t, n, r) {
		if (e.shorthand = !1, this.eat(10)) return e.value = n ? this.parseMaybeDefault(this.state.startLoc) : this.parseMaybeAssignAllowInOrVoidPattern(4, r), this.finishObjectProperty(e);
		if (!e.computed && e.key.type === "Identifier") {
			if (this.checkReservedWord(e.key.name, e.key.start, !0, !1), n) e.value = this.parseMaybeDefault(t, this.cloneIdentifier(e.key));
			else if (this.match(25)) {
				let n = this.state.startLoc;
				r == null ? this.raise(g.InvalidCoverInitializedName, n) : r.shorthandAssignLoc === null && (r.shorthandAssignLoc = n), e.value = this.parseMaybeDefault(t, this.cloneIdentifier(e.key));
	...
	parsePropertyName(e, t) {
		if (this.eat(0)) e.computed = !0, e.key = this.parseMaybeAssignAllowIn(), this.expect(1);
			...
			if (O(n)) i = this.parseIdentifier(!0);
				...
				case 134: {
					let e = this.state.startLoc;
					t == null ? this.raise(g.UnexpectedPrivateField, e) : t.privateKeyLoc === null && (t.privateKeyLoc = e), i = this.parsePrivateName();
					break;
				}
				default: this.unexpected();
			}
			e.key = i, n !== 134 && (e.computed = !1);
		}
	}
	initFunction(e, t) {
	...
	parseMethod(e, t, n, r, i, a, o = !1) {
		this.initFunction(e, n), e.generator = t, this.scope.enter(530 | (o ? 576 : 0) | (i ? 32 : 0)), this.prodParam.enter(Qt(n, e.generator)), this.parseFunctionParams(e, r);
		let s = this.parseFunctionBodyAndFinish(e, a, !0);
		return this.prodParam.exit(), this.scope.exit(), s;
	}
	parseArrayLike(e, t) {
		let n = this.startNode();
		return this.next(), n.elements = this.parseExprList(e, !0, t, n), this.finishNode(n, "ArrayExpression");
	}
	...
	parseFunctionBody(e, t, n = !1) {
		...
		if (this.expressionScope.enter(Xt()), r) e.body = this.parseMaybeAssign(), this.checkParams(e, !1, t, !1);
		else {
			...
			this.state.labels = [], this.prodParam.enter(this.prodParam.currentFlags() | 4), e.body = this.parseBlock(!0, !1, (i) => {
				...
				i && a && this.raise(g.IllegalLanguageModeDirective, (e.kind === "method" || e.kind === "constructor") && e.key ? this.optionFlags & 256 ? e.key.loc.end : e.key : e);
	...
	parseExprList(e, t, n, r) {
		...
		for (; !this.eat(e);) {
			...
			i.push(this.parseExprListItem(e, t, n));
		}
		return i;
	}
	parseExprListItem(e, t, n, r) {
		let i;
		if (this.match(8)) t || this.raise(g.UnexpectedToken, this.state.curPosition(), { unexpected: "," }), i = null;
		else if (this.match(17)) {
			let e = this.state.startLoc;
			i = this.parseParenItem(this.parseSpread(n), e);
		...
		} else i = this.parseMaybeAssignAllowInOrVoidPattern(e, n, this.parseParenItem);
		return i;
	}
	parseIdentifier(e) {
	...
	createIdentifierAt(e, t, n) {
		return e.name = t, this.optionFlags & 256 && (e.loc.identifierName = t), this.finishNodeAt(e, "Identifier", n);
	}
	...
	checkReservedWord(e, t, n, r) {
		if (!(e.length > 10 || !rt(e))) {
			...
			if ((this.state.strict ? r ? $e : Ze : Xe)(e, this.inModule)) {
				this.raise(g.UnexpectedReservedWord, t, { reservedWord: e });
				return;
			} else if (e === "yield") {
				if (this.prodParam.hasYield) {
					this.raise(g.YieldBindingIdentifier, t);
					return;
				}
			} else if (e === "await") {
				if (this.prodParam.hasAwait) {
					this.raise(g.AwaitBindingIdentifier, t);
					return;
				}
				if (this.scope.inStaticBlock) {
					this.raise(g.AwaitBindingIdentifierInStaticBlock, t);
					return;
				}
				this.expressionScope.recordAsyncArrowParametersError(t);
			} else if (e === "arguments" && this.scope.inClassAndNotInNonArrowFunction) {
				this.raise(g.ArgumentsInClass, t);
				return;
			}
		}
	}
	...
	parseAwait(e, t) {
		...
		return this.expressionScope.recordParameterInitializerError(g.AwaitExpressionFormalParameter, n), this.eat(51) && this.raise(g.ObsoleteAwaitStar, e), !this.scope.inFunction && !(this.optionFlags & 1) && (this.isAmbiguousPrefixOrIdentifier() ? this.ambiguousScriptDifferentAst = !0 : this.sawUnambiguousESM = !0), t || (r.argument = this.parseMaybeUnary(null, !0)), this.finishNode(r, "AwaitExpression");
	}
	isAmbiguousPrefixOrIdentifier() {
		if (this.hasPrecedingLineBreak()) return !0;
		let { type: e } = this.state;
		return e === 49 || e === 6 || e === 0 || Ie(e) || e === 98 && !this.state.containsEsc || e === 133 || e === 52 || this.hasPlugin("v8intrinsic") && e === 50;
	}
	parseYield(e) {
		this.setLoc(e);
		let t = this.startNodeAt(e);
		this.expressionScope.recordParameterInitializerError(g.YieldInParameter, e.index);
		let n = !1, r = null;
		if (!this.hasPrecedingLineBreak()) switch (n = this.eat(51), this.state.type) {
			case 9:
			case 135:
			case 4:
			case 7:
	...
	parseImportCall(e) {
		...
		if (t.length === 0 || t.length > 2) this.raise(g.ImportCallArity, e, e);
		else for (let n of t) n.type === "SpreadElement" && this.raise(g.ImportCallSpreadArgument, n, e);
	...
	withTopicBindingContext(e) {
		...
		let n = this.state.seenTopicReference;
		this.state.seenTopicReference = !1;
		try {
			return e();
		} finally {
			this.state.inHackPipelineBody = t, this.state.seenTopicReference = n;
		}
	}
	allowInAnd(e) {
	...
	disallowInAnd(e) {
		let t = this.prodParam.currentFlags(), n = 8 & t, r = 16 & ~t;
		if (n || r) {
	...
	parseFSharpPipelineBody(e) {
		...
		if (this.isContextual(92) && this.recordAwaitIfAllowed()) {
			...
			ke(e) && e !== 35 && (this.prodParam.hasIn || e !== 54) && this.raise(g.PipelineUnparenthesized, t);
	...
	parseMaybeAssignAllowInOrVoidPattern(e, t, n) {
		if (t != null && this.match(84)) {
			let n = this.lookaheadCharCode();
			if (n === 44 || n === (e === 1 ? 93 : e === 4 ? 125 : 41) || n === 61) return this.parseMaybeDefault(this.state.startLoc, this.parseVoidPattern(t));
		}
		return this.parseMaybeAssignAllowIn(t, n);
	}
	parsePropertyNamePrefixOperator(e) {}
}, sn = { kind: 1 }, cn = { kind: 2 }, ln = /[\uD800-\uDFFF]/u, un = /in(?:stanceof)?/y;
function dn(e) {
	for (let t = 0; t < e.length; t++) {
		let n = e[t], { type: r } = n;
		typeof r == "number" && (n.type = Le(r));
	}
	return e;
}
var fn = class extends on {
	parseTopLevel(e, t) {
		return e.program = this.parseProgram(t, 135, this.options.sourceType === "module" ? "module" : "script"), e.comments = this.comments, this.optionFlags & 512 && (e.tokens = dn(this.tokens)), this.finishNode(e, "File");
	}
	parseProgram(e, t, n) {
		if (e.sourceType = n, e.interpreter = this.parseInterpreterDirective(), this.parseBlockBody(e, !0, !0, t), this.inModule) {
			if (!(this.optionFlags & 64) && this.scope.undefinedExports.size > 0) for (let [e, t] of Array.from(this.scope.undefinedExports)) this.raise(g.ModuleExportUndefined, t, { localName: e });
			this.addExtra(e, "topLevelAwait", this.state.hasTopLevelAwait);
		}
		let r;
		return r = t === 135 ? this.finishNode(e, "Program") : this.finishNodeAt(e, "Program", u(this.state.startLoc, -1)), r;
	}
	stmtToDirective(e) {
	...
	chStartsBindingIdentifier(e, t) {
		if (M(e)) {
			if (un.lastIndex = t, un.test(this.input)) {
				let e = this.codePointAtPos(un.lastIndex);
	...
	parseStatementContent(e, t) {
		...
		switch (n) {
			case 56: return this.parseBreakContinueStatement(r, !0);
			case 59: return this.parseBreakContinueStatement(r, !1);
			case 60: return this.parseDebuggerStatement(r);
			case 86: return this.parseDoWhileStatement(r);
			case 87: return this.parseForStatement(r);
			case 64:
				if (this.lookaheadCharCode() === 46) break;
				return a || this.raise(this.state.strict ? g.StrictFunction : this.options.annexB ? g.SloppyFunctionAnnexB : g.SloppyFunction, this.state.startLoc), this.parseFunctionStatement(r, !1, !i && a);
			case 76: return i || this.unexpected(), this.parseClass(this.maybeTakeDecorators(t, r), !0);
			case 65: return this.parseIfStatement(r);
			case 66: return this.parseReturnStatement(r);
			case 67: return this.parseSwitchStatement(r);
			case 68: return this.parseThrowStatement(r);
			case 69: return this.parseTryStatement(r);
			case 92:
				if (this.isAwaitUsing()) return this.allowsUsing() ? i ? this.recordAwaitIfAllowed() || this.raise(g.AwaitUsingNotInAsyncContext, r) : this.raise(g.UnexpectedLexicalDeclaration, r) : this.raise(g.UnexpectedUsingDeclaration, r), this.next(), this.parseVarStatement(r, "await using");
				break;
			case 103:
				if (this.state.containsEsc || !this.hasInLineFollowingBindingIdentifierOrBrace()) break;
				return this.allowsUsing() ? i || this.raise(g.UnexpectedLexicalDeclaration, this.state.startLoc) : this.raise(g.UnexpectedUsingDeclaration, this.state.startLoc), this.parseVarStatement(r, "using");
			case 96: {
				if (this.state.containsEsc) break;
				let e = this.nextTokenStart(), t = this.codePointAtPos(e);
				if (t !== 91 && (!i && this.hasFollowingLineBreak() || !this.chStartsBindingIdentifier(t, e) && t !== 123)) break;
			}
			case 71: i || this.raise(g.UnexpectedLexicalDeclaration, this.state.startLoc);
			case 70: {
				let e = this.state.value;
				return this.parseVarStatement(r, e);
			}
			case 88: return this.parseWhileStatement(r);
			case 72: return this.parseWithStatement(r);
			case 2: return this.parseBlock();
			case 9: return this.parseEmptyStatement(r);
			case 79: {
				let e = this.lookaheadCharCode();
				if (e === 40 || e === 46) break;
			}
			case 78: {
				!(this.optionFlags & 8) && !o && this.raise(g.UnexpectedImportExport, this.state.startLoc), this.next();
				let e;
				return e = n === 79 ? this.parseImport(r) : this.parseExport(r, t), this.assertModuleNodeAllowed(e), e;
			}
	...
	maybeTakeDecorators(e, t, n) {
		return e && (t.decorators?.length ? (this.raise(g.DecoratorsBeforeAfterExport, t.decorators[0]), t.decorators.unshift(...e)) : t.decorators = e, this.resetStartLocationFromNode(t, e[0]), n && this.resetStartLocationFromNode(n, t)), t;
	}
	...
	parseDecorator() {
		...
		if (this.next(), this.hasPlugin("decorators")) {
			...
			if (this.match(6)) {
				let t = this.state.startLoc;
				this.next(), n = this.parseExpression(), this.expect(7), n = this.wrapParenthesis(t, n);
				let r = this.state.startLoc;
				e.expression = this.parseMaybeDecoratorArguments(n, t), e.expression !== n && this.raise(g.DecoratorArgumentsOutsideParentheses, r);
			} else {
				for (n = this.parseIdentifier(!1); this.eat(12);) {
					let e = this.startNodeAt(t);
					e.object = n, this.match(134) ? (this.classScope.usePrivateName(this.state.value, this.state.startLoc), e.property = this.parsePrivateName()) : e.property = this.parseIdentifier(!0), e.computed = !1, n = this.finishNode(e, "MemberExpression");
				}
	...
	parseMaybeDecoratorArguments(e, t) {
		if (this.eat(6)) {
			let n = this.startNodeAt(t);
			return n.callee = e, n.arguments = this.parseCallExpressionArguments(), this.toReferencedList(n.arguments), this.finishNode(n, "CallExpression");
		}
		return e;
	}
	...
	verifyBreakContinue(e, t) {
		...
		if (n === this.state.labels.length) {
			...
			this.raise(g.IllegalBreakContinue, e, { type: n });
		}
	}
	...
	parseDoWhileStatement(e) {
		return this.next(), this.state.labels.push(sn), e.body = this.parseStatement(), this.state.labels.pop(), this.expect(88), e.test = this.parseHeaderExpression(), this.eat(9), this.finishNode(e, "DoWhileStatement");
	}
	parseForStatement(e) {
		this.next(), this.state.labels.push(sn);
		let t = null;
		...
		{
			let r = this.isAwaitUsing(), i = r || this.isForUsing(), a = n && this.hasFollowingBindingAtom() || i;
			if (this.match(70) || this.match(71) || a) {
				let n = this.startNode(), a;
				r ? (a = "await using", this.recordAwaitIfAllowed() || this.raise(g.AwaitUsingNotInAsyncContext, this.state.startLoc), this.next()) : a = this.state.value, this.next(), this.parseVar(n, !0, a);
				let o = this.finishNode(n, "VariableDeclaration"), s = this.match(54);
		...
		let r = this.isContextual(91), i = new en(), a = this.parseExpression(!0, i), o = this.isContextual(98);
	...
	parseReturnStatement(e) {
		return this.prodParam.hasReturn || this.raise(g.IllegalReturn, this.state.startLoc), this.next(), this.isLineTerminator() ? e.argument = null : (e.argument = this.parseExpression(), this.semicolon()), this.finishNode(e, "ReturnStatement");
	}
	parseSwitchStatement(e) {
		this.next(), e.discriminant = this.parseHeaderExpression();
		let t = e.cases = [];
		this.expect(2), this.state.labels.push(cn), this.scope.enter(256);
		let n;
		for (let e; !this.match(4);) if (this.match(57) || this.match(61)) {
			let r = this.match(57);
			n && this.finishNode(n, "SwitchCase"), t.push(n = this.startNode()), n.consequent = [], this.next(), r ? n.test = this.parseExpression() : (e && this.raise(g.MultipleDefaultsInSwitch, this.state.lastTokStartLoc), e = !0, n.test = null), this.expect(10);
	...
	parseTryStatement(e) {
		...
		return e.finalizer = this.eat(63) ? this.parseBlock() : null, !e.handler && !e.finalizer && this.raise(g.NoCatchOrFinally, e), this.finishNode(e, "TryStatement");
	}
	...
	parseWhileStatement(e) {
		return this.next(), e.test = this.parseHeaderExpression(), this.state.labels.push(sn), e.body = this.parseStatement(), this.state.labels.pop(), this.finishNode(e, "WhileStatement");
	}
	...
	parseLabeledStatement(e, t, n, r) {
		...
		let i = De(this.state.type) ? 1 : this.match(67) ? 2 : null;
	...
	parseBlock(e = !1, t = !0, n) {
		...
		return e && this.state.strictErrors.clear(), this.expect(2), t && this.scope.enter(0), this.parseBlockBody(r, e, !1, 4, n), t && this.scope.exit(), this.finishNode(r, "BlockStatement");
	}
	isValidDirective(e) {
	...
	parseFunction(e, t = 0) {
		...
		return this.initFunction(e, a), this.match(51) && (n && this.raise(g.GeneratorInSingleStatementContext, this.state.startLoc), this.next(), e.generator = !0), r && (e.id = this.parseFunctionId(i)), this.scope.enter(514), this.prodParam.enter(Qt(a, e.generator)), r || (e.id = this.parseFunctionId()), this.parseFunctionParams(e, !1), this.parseFunctionBodyAndFinish(e, r ? "FunctionDeclaration" : "FunctionExpression"), this.prodParam.exit(), this.scope.exit(), r && !n && this.registerFunctionStatementId(e), e;
	}
	parseFunctionId(e) {
		return e || D(this.state.type) ? this.parseIdentifier() : null;
	}
	parseFunctionParams(e, t) {
		this.expect(6), this.expressionScope.enter(qt()), e.params = this.parseBindingList(7, 41, 2 | (t ? 4 : 0)), this.expressionScope.exit();
	}
	...
	parseClassBody(e, t) {
		...
		for (i.body = [], this.expect(2); !this.match(4);) {
			if (this.eat(9)) {
				if (r.length > 0) throw this.raise(g.DecoratorSemicolon, this.state.lastTokEndLoc);
				continue;
			}
			if (this.match(22)) {
			...
			let e = this.startNode();
			r.length && (e.decorators = r, this.resetStartLocationFromNode(e, r[0]), r = []), this.parseClassMember(i, e, n);
		}
		if (this.state.strict = t, this.next(), r.length) throw this.raise(g.TrailingDecorator, this.state.startLoc);
	...
	parseClassMemberWithIsStatic(e, t, n, r) {
		...
		if (t.static = r, this.parsePropertyNamePrefixOperator(t), this.eat(51)) {
			l.kind = "method";
			let t = this.match(134);
		...
		let d = !this.state.containsEsc && D(this.state.type), f = this.parseClassElementName(t), p = d ? f.name : null, m = this.isPrivateName(f), ee = this.state.startLoc;
		if (this.parsePostMemberNameModifiers(u), this.isClassMethod()) {
			...
			r && (i.kind = "constructor", i.decorators && i.decorators.length > 0 && this.raise(g.DecoratorConstructor, t), n.hadConstructor && !this.hasPlugin("typescript") && this.raise(g.DuplicateConstructor, f), r && this.hasPlugin("typescript") && t.override && this.raise(g.OverrideOnConstructor, f), n.hadConstructor = !0, o = n.hadSuperClass), this.pushClassMethod(e, i, !1, !1, r, o);
			...
			let t = this.eat(51);
			u.optional && this.unexpected(ee), l.kind = "method";
			let n = this.match(134);
			this.parseClassElementName(l), this.parsePostMemberNameModifiers(u), n ? this.pushClassPrivateMethod(e, a, t, !0) : (this.isNonstaticConstructor(i) && this.raise(g.ConstructorIsAsync, i.key), this.pushClassMethod(e, i, t, !0, !1, !1));
		} else if ((p === "get" || p === "set") && !(this.match(51) && this.isLineTerminator())) {
			this.resetPreviousNodeTrailingComments(f), l.kind = p;
			let t = this.match(134);
			this.parseClassElementName(i), t ? this.pushClassPrivateMethod(e, a, !1, !1) : (this.isNonstaticConstructor(i) && this.raise(g.ConstructorIsAccessor, i.key), this.pushClassMethod(e, i, !1, !1, !1, !1)), this.checkGetterSetterParams(i);
	...
	parseClassElementName(e) {
		...
		if ((t === 128 || t === 130) && e.static && n === "prototype" && this.raise(g.StaticPrototype, this.state.startLoc), t === 134) {
			n === "constructor" && this.raise(g.ConstructorClassPrivateField, this.state.startLoc);
	...
	parseClassStaticBlock(e, t) {
		...
		let r = t.body = [];
		this.parseBlockOrModuleBlockBody(r, void 0, !1, 4), this.prodParam.exit(), this.scope.exit(), this.state.labels = n, e.body.push(this.finishNode(t, "StaticBlock")), t.decorators?.length && this.raise(g.DecoratorStaticBlock, t);
	}
	...
	pushClassPrivateProperty(e, t) {
		...
		e.body.push(n), this.classScope.declarePrivateName(this.getPrivateNameSV(n.key), 0, n.key.start);
	}
	pushClassAccessorProperty(e, t, n) {
		!n && !t.computed && this.nameIsConstructor(t.key) && this.raise(g.ConstructorClassField, t.key);
		let r = this.parseClassAccessorProperty(t);
		e.body.push(r), n && this.classScope.declarePrivateName(this.getPrivateNameSV(r.key), 0, r.key.start);
	}
	pushClassMethod(e, t, n, r, i, a) {
	...
	parseInitializer(e) {
		this.scope.enter(592), this.expressionScope.enter(Xt()), this.prodParam.enter(0), e.value = this.eat(25) ? this.parseMaybeAssignAllowIn() : null, this.expressionScope.exit(), this.prodParam.exit(), this.scope.exit();
	}
	...
	parseExport(e, t) {
		let n = this.parseMaybeImportPhase(e, !0), r = this.maybeParseExportDefaultSpecifier(e, n), i = !r || this.eat(8), a = i && this.eatExportStar(e), o = a && this.maybeParseExportNamespaceSpecifier(e), s = i && (!o || this.eat(8)), c = r || a;
		if (a && !o) {
			if (r && this.unexpected(), t) throw this.raise(g.UnsupportedDecoratorExport, e);
		...
		r && i && !a && !l && this.unexpected(null, 2), o && s && this.unexpected(null, 94);
		let u;
		if (c || l) {
			if (u = !1, t) throw this.raise(g.UnsupportedDecoratorExport, e);
	...
	maybeParseExportNamedSpecifiers(e) {
		if (this.match(2)) {
			...
			return t.specifiers.push(...this.parseExportSpecifiers(n)), t.source = null, t.attributes = [], t.declaration = null, !0;
		}
		return !1;
	}
	...
	parseExportDefaultExpression() {
		...
		if (this.match(71) || this.match(70) || this.isLet() || this.isUsing() || this.isAwaitUsing()) throw this.raise(g.UnsupportedDefaultExport, this.state.startLoc);
	...
	isExportDefaultSpecifier() {
		...
		if (D(e)) {
			...
			if ((e === 126 || e === 125) && !this.state.containsEsc) {
				...
				if (t === 123 || this.chStartsBindingIdentifier(t, e) && !this.input.startsWith("from", e)) return this.expectOnePlugin(["flow", "typescript"]), !1;
			}
	...
	shouldParseExportDeclaration() {
		let { type: e } = this.state;
		return e === 22 && (this.expectOnePlugin(["decorators", "decorators-legacy"]), this.hasPlugin("decorators")) ? !0 : this.isUsing() || this.isAwaitUsing() ? (this.raise(g.UsingDeclarationExport, this.state.startLoc), !0) : e === 70 || e === 71 || e === 64 || e === 76 || this.isLet() || this.isAsyncFunction();
	}
	checkExport(e, t, n, r) {
		if (t) {
			if (n) {
				if (this.checkDuplicateExports(e, "default"), this.hasPlugin("exportDefaultFrom")) {
					let t = e.declaration;
					t.type === "Identifier" && t.name === "from" && t.end - t.start === 4 && !t.extra?.parenthesized && this.raise(g.ExportDefaultFromAsIdentifier, t);
				}
			} else if (e.specifiers?.length) for (let t of e.specifiers) {
				let { exported: e } = t, n = e.type === "Identifier" ? e.name : e.value;
				if (this.checkDuplicateExports(t, n), !r && t.local) {
					let { local: e } = t;
					e.type === "Identifier" ? (this.checkReservedWord(e.name, e.start, !0, !1), this.scope.checkLocalExport(e)) : this.raise(g.ExportBindingIsString, t, {
						localName: e.value,
						exportName: n
					});
				}
	...
	checkDuplicateExports(e, t) {
		this.exportedIdentifiers.has(t) && (t === "default" ? this.raise(g.DuplicateDefaultExport, e) : this.raise(g.DuplicateExport, e, { exportName: t })), this.exportedIdentifiers.add(t);
	}
	parseExportSpecifiers(e) {
		...
		for (this.expect(2); !this.eat(4);) {
			...
			let r = this.isContextual(126), i = this.match(130), a = this.startNode();
			a.local = this.parseModuleExportName(), t.push(this.parseExportSpecifier(a, i, e, r));
		}
		return t;
	}
	parseExportSpecifier(e, t, n, r) {
		return this.eatContextual(89) ? e.exported = this.parseModuleExportName() : t ? e.exported = this.cloneStringLiteral(e.local) : e.exported ||= this.cloneIdentifier(e.local), this.finishNode(e, "ExportSpecifier");
	}
	parseModuleExportName() {
		if (this.match(130)) {
			let e = this.parseStringLiteral(this.state.value), t = ln.exec(e.value);
	...
	checkImportPhase(e) {
		...
		e.phase === "source" ? n !== "ImportDefaultSpecifier" && this.raise(g.SourcePhaseImportRequiresDefault, t[0]) : e.phase === "defer" && n !== "ImportNamespaceSpecifier" && this.raise(g.DeferImportRequiresNamespace, t[0]);
	}
	isPotentialImportPhase(e) {
		return e ? !1 : this.isContextual(101) || this.isContextual(93);
	}
	applyImportPhase(e, t, n, r) {
		t || (n === "source" ? (this.expectPlugin("sourcePhaseImports", r), e.phase = "source") : n === "defer" ? (this.expectPlugin("deferredImportEvaluation", r), e.phase = "defer") : this.hasPlugin("sourcePhaseImports") && (e.phase = null));
	}
	...
	parseImportSpecifiersAndAfter(e, t) {
		e.specifiers = [];
		let n = !this.maybeParseDefaultImportSpecifier(e, t) || this.eat(8), r = n && this.maybeParseStarImportSpecifier(e);
		return n && !r && this.parseNamedImportSpecifiers(e), this.expectContextual(94), this.parseImportSourceAndAttributes(e);
	}
	parseImportSourceAndAttributes(e) {
		return e.specifiers ??= [], e.source = this.parseImportSource(), this.maybeParseImportAttributes(e), this.checkImportPhase(e), this.semicolon(), this.sawUnambiguousESM = !0, this.finishNode(e, "ImportDeclaration");
	}
	parseImportSource() {
	...
	parseImportAttributes() {
		...
		do {
			...
			if (t.has(r) && this.raise(g.ModuleAttributesWithDuplicateKeys, this.state.startLoc, { key: r }), t.add(r), this.match(130) ? n.key = this.parseStringLiteral(r) : n.key = this.parseIdentifier(!0), this.expect(10), !this.match(130)) throw this.raise(g.ModuleAttributeInvalidValue, this.state.startLoc);
	...
	maybeParseDefaultImportSpecifier(e, t) {
		...
		} else if (O(this.state.type)) return this.parseImportSpecifierLocal(e, this.startNode(), "ImportDefaultSpecifier"), !0;
		return !1;
	}
	...
	parseNamedImportSpecifiers(e) {
		...
		for (this.expect(2); !this.eat(4);) {
			if (t) t = !1;
				...
				if (this.eat(10)) throw this.raise(g.DestructureNamedImport, this.state.startLoc);
				if (this.expect(8), this.eat(4)) break;
			}
			let n = this.startNode(), r = this.match(130), i = this.isContextual(126);
	...
	parseImportSpecifier(e, t, n, r, i) {
		if (this.eatContextual(89)) e.local = this.parseIdentifier();
			...
			let { imported: n } = e;
			if (t) throw this.raise(g.ImportBindingIsString, e, { importName: n.value });
			this.checkReservedWord(n.name, e.start, !0, !0), e.local ||= this.cloneIdentifier(n);
		}
...
var H = h`typescript`({
	...
	DecoratorAbstractMethod: ({ kind: e }) => `Decorators can't be used with ${e.startsWith("a") ? "an" : "a"} ${e}.`,
	...
	UnexpectedTypeDeclaration: (e) => `'${e}' declarations can only be declared inside a block.`,
...
function yn(e) {
	...
	switch (e.type) {
		...
		case "MemberExpression": return !e.computed && yn(e.object);
		case "TSInstantiationExpression": return yn(e.expression);
		default: return !1;
	}
}
var bn = (e) => class extends e {
	...
	tsParseModifiers({ allowedModifiers: e, disallowedModifiers: t, stopOnStartOfClassStaticBlock: n, errorTemplate: r = H.InvalidModifierOnTypeMember }, i) {
		...
		for (;;) {
			let { startLoc: c } = this.state, l = this.tsParseModifier(e.concat(t ?? []), n, i.static);
			if (!l) break;
			_n(l) ? i.accessibility ? this.raise(H.DuplicateAccessibilityModifier, c, { modifier: l }) : (a(c, l, l, "override"), a(c, l, l, "static"), a(c, l, l, "readonly"), i.accessibility = l) : vn(l) ? (i[l] && this.raise(H.DuplicateModifier, c, { modifier: l }), i[l] = !0, a(c, l, "in", "out")) : (s(i, l) ? this.raise(H.DuplicateModifier, c, { modifier: l }) : (a(c, l, "static", "readonly"), a(c, l, "static", "override"), a(c, l, "override", "readonly"), a(c, l, "abstract", "override"), o(c, l, "declare", "override"), o(c, l, "static", "abstract")), i[l] = !0), t?.includes(l) && this.raise(r, c, { modifier: l });
		}
	}
	...
	tsParseDelimitedList(e, t, n) {
		return mn(this.tsParseDelimitedListWorker(e, t, !0, n));
	}
	...
	tsParseBracketedList(e, t, n, r, i) {
		r || (n ? this.expect(0) : this.expect(43));
		let a = this.tsParseDelimitedList(e, t, i);
		return n ? this.expect(1) : this.expect(44), a;
	}
	tsParseImportType() {
		let e = this.startNode();
	...
	tsParseImportTypeOptions() {
		...
		this.expect(2);
		let t = this.startNode();
		return this.isContextual(72) ? (t.method = !1, t.key = this.parseIdentifier(!0), t.computed = !1, t.shorthand = !1) : this.unexpected(null, 72), this.expect(10), t.value = this.tsParseImportTypeWithPropertyValue(), e.properties = [this.finishObjectProperty(t)], this.eat(8), this.expect(4), this.finishNode(e, "ObjectExpression");
	}
	...
	tsParseEntityName(e) {
		let t;
		if (e & 1 && this.match(74)) if (e & 2) t = this.parseIdentifier(!0);
		else {
			let e = this.startNode();
	...
	tsParseTypeReference() {
		let e = this.startNode();
		return e.typeName = this.tsParseEntityName(1), !this.hasPrecedingLineBreak() && this.match(43) && (e.typeArguments = this.tsParseTypeArguments()), this.finishNode(e, "TSTypeReference");
	}
	...
	tsParseTypeQuery() {
		let e = this.startNode();
		return this.expect(83), this.match(79) ? e.exprName = this.tsParseImportType() : e.exprName = this.tsParseEntityName(1), !this.hasPrecedingLineBreak() && this.match(43) && (e.typeArguments = this.tsParseTypeArguments()), this.finishNode(e, "TSTypeQuery");
	}
	...
	tsParseTypeParameter(e) {
		let t = this.startNode();
		return e(t), t.name = this.tsParseTypeParameterName(), t.constraint = this.tsEatThenParseType(77), t.default = this.tsEatThenParseType(25), this.finishNode(t, "TSTypeParameter");
	}
	...
	tsFillSignature(e, t) {
		let n = e === 15;
		t.typeParameters = this.tsTryParseTypeParameters(this.tsParseConstModifier), this.expect(6), t.params = this.tsParseBindingListForSignature(), (n || this.match(e)) && (t.returnType = this.tsParseTypeOrTypePredicateAnnotation(e));
	}
	...
	tsTryParseIndexSignature(e) {
		...
		this.expect(0);
		let t = this.parseIdentifier();
		t.typeAnnotation = this.tsParseTypeAnnotation(), this.resetEndLocation(t), this.expect(1), e.parameters = [t];
	...
	tsParseTypeMember() {
		let e = this.startNode();
		if (this.match(6) || this.match(43)) return this.tsParseSignatureMember("TSCallSignatureDeclaration", e);
		if (this.match(73)) {
			let t = this.startNode();
			return this.next(), this.match(6) || this.match(43) ? this.tsParseSignatureMember("TSConstructSignatureDeclaration", e) : (e.key = this.createIdentifier(t, "new"), this.tsParsePropertyOrMethodSignature(e, !1));
		}
		...
		}, e), this.tsTryParseIndexSignature(e) || (super.parsePropertyName(e), !e.computed && e.key.type === "Identifier" && (e.key.name === "get" || e.key.name === "set") && this.tsTokenCanFollowModifier() && (e.kind = e.key.name, super.parsePropertyName(e), !this.match(6) && !this.match(43) && this.unexpected(null, 6)), this.tsParsePropertyOrMethodSignature(e, !!e.readonly));
	}
	tsParseTypeLiteral() {
		let e = this.startNode();
	...
	tsParseMappedType() {
		let e = this.startNode();
		return this.expect(2), this.match(49) ? (e.readonly = this.state.value, this.next(), this.expectContextual(118)) : this.eatContextual(118) && (e.readonly = !0), this.expect(0), e.key = this.tsParseTypeParameterName(), e.constraint = this.tsExpectThenParseType(54), e.nameType = this.eatContextual(89) ? this.tsParseType() : null, this.expect(1), this.match(49) ? (e.optional = this.state.value, this.next(), this.expect(13)) : this.eat(13) && (e.optional = !0), e.typeAnnotation = this.tsTryParseType(), this.semicolon(), this.expect(4), this.finishNode(e, "TSMappedType");
	}
	tsParseTupleType() {
		let e = this.startNode();
	...
	tsParseTupleElementType() {
		...
		if (s === 58) r = !0, a = !1, i = this.parseIdentifier(!0), this.expect(10), o = this.tsParseType();
			...
			this.lookaheadCharCode() === 58 ? (r = !0, i = this.createIdentifier(this.startNodeAt(n), e), this.expect(13), this.expect(10), o = this.tsParseType()) : (r = !1, o = t, this.expect(13));
	...
	tsParseParenthesizedType() {
		let e = this.startNode();
		return this.expect(6), e.typeAnnotation = this.tsParseType(), this.expect(7), this.finishNode(e, "TSParenthesizedType");
	}
	tsParseFunctionOrConstructorType(e, t) {
		let n = this.startNode();
		return e === "TSConstructorType" && (n.abstract = !!t, t && this.next(), this.next()), this.tsInAllowConditionalTypesContext(() => this.tsFillSignature(15, n)), this.finishNode(n, e);
	}
	...
	tsParseTemplateLiteralType() {
		let e = this.state.startLoc, t = this.parseTemplateElement(!1), n = [t];
		if (t.tail) {
			let t = this.startNodeAt(e), r = this.startNodeAt(e);
			return r.expressions = [], r.quasis = n, t.literal = this.finishNode(r, "TemplateLiteral"), this.finishNode(t, "TSLiteralType");
		} else {
			let r = [];
			for (; !t.tail;) r.push(this.tsParseType()), this.readTemplateContinuation(), n.push(t = this.parseTemplateElement(!1));
			let i = this.startNodeAt(e);
			return i.types = r, i.quasis = n, this.finishNode(i, "TSTemplateLiteralType");
		}
	}
	parseTemplateSubstitution() {
	...
	tsParseThisTypeOrThisTypePredicate() {
		...
		return this.isContextual(112) && !this.hasPrecedingLineBreak() ? this.tsParseThisTypePredicate(e) : e;
	}
	tsParseNonArrayType() {
		switch (this.state.type) {
			case 130:
			...
			case 49:
				if (this.state.value === "-") {
					...
					return t.type !== 131 && t.type !== 132 && this.unexpected(), e.literal = this.parseMaybeUnary(), this.finishNode(e, "TSLiteralType");
				}
				break;
			...
			case 6:
				if (!(this.optionFlags & 2048)) {
					...
					return this.expect(7), this.addExtra(t, "parenthesized", !0), this.addExtra(t, "parenStart", e.index), t;
				}
			...
			default: {
				let { type: e } = this.state;
				if (D(e) || e === 84 || e === 80) {
					let t = e === 84 ? "TSVoidKeyword" : e === 80 ? "TSNullKeyword" : gn(this.state.value);
	...
	tsParseArrayTypeOrHigher() {
		...
		for (; !this.hasPrecedingLineBreak() && this.eat(0);) if (this.match(1)) {
			let n = this.startNodeAt(e);
			n.elementType = t, this.expect(1), t = this.finishNode(n, "TSArrayType");
		} else {
			let n = this.startNodeAt(e);
			n.objectType = t, n.indexType = this.tsParseType(), this.expect(1), t = this.finishNode(n, "TSIndexedAccessType");
		}
		return t;
	}
	tsParseTypeOperator() {
	...
	tsParseConstraintForInferType() {
		if (this.eat(77)) {
			...
			if (this.state.inDisallowConditionalTypesContext || !this.match(13)) return e;
		}
	}
	tsParseTypeOperatorOrHigher() {
		return Me(this.state.type) && !this.state.containsEsc ? this.tsParseTypeOperator() : this.isContextual(111) ? this.tsParseInferType() : this.tsInAllowConditionalTypesContext(() => this.tsParseArrayTypeOrHigher());
	}
	...
	tsParseTypePredicatePrefix() {
		...
		if (this.isContextual(112) && !this.hasPrecedingLineBreak()) return this.next(), e;
	}
	...
	tsParseHeritageClause(e) {
		let t = this.state.startLoc, n = this.tsParseDelimitedList("HeritageClauseElement", () => {
			...
			yn(t) || this.raise(H.InvalidHeritageClauseType, t.start, { token: e });
	...
	tsParseInterfaceDeclaration(e, t = {}) {
		...
		this.expectContextual(125), t.declare && (e.declare = !0), D(this.state.type) ? (e.id = this.parseIdentifier(), this.checkIdentifier(e.id, 130)) : (e.id = null, this.raise(H.MissingInterfaceName, this.state.startLoc)), e.typeParameters = this.tsTryParseTypeParameters(this.tsParseInOutConstModifiers), this.eat(77) && (e.extends = this.tsParseHeritageClause("extends"));
		let n = this.startNode();
	...
	tsParseTypeAliasDeclaration(e) {
		return e.id = this.parseIdentifier(), this.checkIdentifier(e.id, 2), e.typeAnnotation = this.tsInType(() => {
			if (e.typeParameters = this.tsTryParseTypeParameters(this.tsParseInOutModifiers), this.expect(25), this.isContextual(110) && this.lookaheadCharCode() !== 46) {
				let e = this.startNode();
	...
	tsParseEnumMember() {
		let e = this.startNode();
		return e.id = this.match(130) ? super.parseStringLiteral(this.state.value) : this.parseIdentifier(!0), this.eat(25) && (e.initializer = super.parseMaybeAssignAllowIn()), this.finishNode(e, "TSEnumMember");
	}
	tsParseEnumDeclaration(e, t = {}) {
		return t.const && (e.const = !0), t.declare && (e.declare = !0), this.expectContextual(122), e.id = this.parseIdentifier(), this.checkIdentifier(e.id, e.const ? 8971 : 8459), e.body = this.tsParseEnumBody(), this.finishNode(e, "TSEnumDeclaration");
	}
	tsParseEnumBody() {
		let e = this.startNode();
		return this.expect(2), e.members = this.tsParseDelimitedList("EnumMembers", this.tsParseEnumMember.bind(this)), this.expect(4), this.finishNode(e, "TSEnumBody");
	}
	tsParseModuleBlock(e) {
		let t = this.startNode();
		return e || this.scope.enter(0), this.expect(2), super.parseBlockOrModuleBlockBody(t.body = [], void 0, !0, 4), e || this.scope.exit(), this.finishNode(t, "TSModuleBlock");
	}
	tsParseNamespaceDeclaration(e) {
		return e.id = this.tsParseEntityName(0), e.id.type === "Identifier" && this.checkIdentifier(e.id, 1024), this.scope.enter(2048), this.prodParam.enter(0), e.body = this.tsParseModuleBlock(!1), this.prodParam.exit(), this.scope.exit(), this.finishNode(e, "TSModuleDeclaration");
	}
	tsParseAmbientExternalModuleDeclaration(e) {
		let t = this.isContextual(108);
		return t ? (e.kind = "global", e.id = this.parseIdentifier()) : (e.kind = "module", e.id = super.parseStringLiteral(this.state.value)), this.match(2) ? (t || this.scope.enter(1024), this.prodParam.enter(0), e.body = this.tsParseModuleBlock(t), this.prodParam.exit(), t || this.scope.exit()) : this.semicolon(), this.finishNode(e, "TSModuleDeclaration");
	}
	...
	tsParseExternalModuleReference() {
		let e = this.startNode();
		return this.expectContextual(115), this.expect(6), this.match(130) || this.unexpected(), e.expression = super.parseExprAtom(), this.expect(7), this.sawUnambiguousESM = !0, this.finishNode(e, "TSExternalModuleReference");
	}
	tsLookAhead(e) {
	...
	tsTryParseDeclare(e) {
		...
		return this.tsInAmbientContext(() => {
			switch (t) {
				case 64: return e.declare = !0, super.parseFunctionStatement(e, !1, !1);
				case 76: return e.declare = !0, this.parseClass(e, !0, !1);
				case 122: return this.tsParseEnumDeclaration(e, { declare: !0 });
				case 108: return this.tsParseAmbientExternalModuleDeclaration(e);
				case 96: if (this.state.containsEsc) return;
				case 71:
				case 70: return !this.match(71) || !this.isLookaheadContextual("enum") ? (e.declare = !0, this.parseVarStatement(e, this.state.value, !0)) : (this.expect(71), this.tsParseEnumDeclaration(e, {
					const: !0,
					declare: !0
				}));
				case 103:
	...
	tsParseDeclaration(e, t, n, r) {
		switch (t) {
			...
			case 124:
				...
				break;
			case 126:
				if (this.tsCheckLineTerminator(n) && D(this.state.type)) return this.tsParseTypeAliasDeclaration(e);
				break;
		}
	}
	...
	tsTryParseGenericAsyncArrowFunction(e) {
		...
		let t = this.tsTryParseAndCatch(() => {
			let t = this.startNodeAt(e);
			return t.typeParameters = this.tsParseTypeParameters(this.tsParseConstModifier), super.parseFunctionParams(t), t.returnType = this.tsTryParseTypeOrTypePredicateAnnotation(), this.expect(15), t;
		});
	...
	tsParseTypeArguments() {
		let e = this.startNode();
		return e.params = this.tsInType(() => this.tsInTopLevelContext(() => (this.expect(43), this.tsParseDelimitedList("TypeParametersOrArguments", this.tsParseType.bind(this))))), e.params.length === 0 ? this.raise(H.EmptyTypeArguments, e) : !this.state.inType && this.curContext() === j.brace && this.reScan_lt_gt(), this.expect(44), this.finishNode(e, "TSTypeParameterInstantiation");
	}
	...
	parseBindingElement(e, t) {
		let n = t.length ? null : this.state.startLoc, r = {};
	...
	parseNewCallee(e) {
		super.parseNewCallee(e);
		let { callee: t } = e;
		t.type === "TSInstantiationExpression" && !t.extra?.parenthesized && (e.typeArguments = t.typeArguments, e.callee = t.expression);
	}
	parseExprOp(e, t, n) {
		let r;
		if (Pe(54) > n && !this.hasPrecedingLineBreak() && (this.isContextual(89) || (r = this.isContextual(116)))) {
			let i = this.startNodeAt(t);
			...
			return this.reScan_lt_gt(), this.parseExprOp(a, t, n);
		}
	...
	parseExport(e, t) {
		if (this.match(79)) {
			...
			this.next();
			let n = null;
			this.isContextual(126) && this.isPotentialImportPhase(!1) ? n = this.parseMaybeImportPhase(t, !1) : t.importKind = "value";
			let r = this.tsParseImportEqualsDeclaration(t, n);
			return e.attributes = [], e.declaration = r, e.exportKind = "value", e.source = null, e.specifiers = [], this.finishNode(e, "ExportNamedDeclaration");
		} else if (this.eat(25)) {
			let t = e;
	...
	parseVarStatement(e, t, n = !1) {
		...
		if (!r) return i;
		if (!e.declare && (t === "using" || t === "await using")) return this.raiseOverwrite(H.UsingDeclarationInAmbientContext, e, t), i;
		for (let { id: e, init: n } of i.declarations) n && (t === "var" || t === "let" || e.typeAnnotation ? this.raise(H.InitializerNotAllowedInAmbientContext, n) : Sn(n, this.hasPlugin("estree")) || this.raise(H.ConstInitializerMustBeStringOrNumericLiteralOrLiteralEnumReference, n));
		return i;
	}
	parseStatementContent(e, t) {
		let n = !!(e & 2);
		if (!this.state.containsEsc) switch (this.state.type) {
			case 71:
				if (this.isLookaheadContextual("enum")) {
					let e = this.startNode();
					return this.next(), this.tsParseEnumDeclaration(e, { const: !0 });
				}
				break;
			case 120:
			case 121:
				if (this.nextTokenIsIdentifierAndNotTSRelationalOperatorOnSameLine()) {
					let e = this.state.type, n = this.startNode();
					this.next();
					let r = e === 121 ? this.tsTryParseDeclare(n) : this.tsParseAbstractDeclaration(n, t);
					return r ? (e === 121 && (r.declare = !0), r) : (n.expression = this.createIdentifier(this.startNodeAtNode(n), e === 121 ? "declare" : "abstract"), this.semicolon(!1), this.finishNode(n, "ExpressionStatement"));
				}
				break;
	...
	tsHasSomeModifiers(e, t) {
		return t.some((t) => _n(t) ? e.accessibility === t : !!e[t]);
	}
	...
	parseConditional(e, t, n) {
		...
		let r = this.startNodeAt(t);
		r.test = e;
		let i = this.state.inConditionalConsequent;
		return this.state.inConditionalConsequent = !0, r.consequent = this.parseMaybeAssignAllowIn(), this.state.inConditionalConsequent = i, this.expect(10), r.alternate = this.parseMaybeAssign(), this.finishNode(r, "ConditionalExpression");
	}
	parseParenItem(e, t) {
		let n = super.parseParenItem(e, t);
		if (this.eat(13) && (n.optional = !0, this.resetEndLocation(e)), this.match(10)) {
	...
	parseClassSuper(e) {
		if (super.parseClassSuper(e), e.superClass) if (e.superClass.type === "TSInstantiationExpression") {
			let t = e.superClass, n = t.expression;
			this.takeSurroundingComments(n, n.start, n.end);
			let r = t.typeArguments;
			this.takeSurroundingComments(r, r.start, r.end), e.superClass = n, e.superTypeArguments = r;
		} else (this.match(43) || this.match(47)) && (e.superTypeArguments = this.tsParseTypeArgumentsInExpression());
		this.eatContextual(109) && (e.implements = this.tsParseHeritageClause("implements"));
	}
	parseObjPropValue(e, t, n, r, i, a, o) {
	...
	parseVarId(e, t) {
		super.parseVarId(e, t), e.id.type === "Identifier" && !this.hasPrecedingLineBreak() && this.eat(31) && (e.definite = !0);
		let n = this.tsTryParseTypeAnnotation();
		n && (e.id.typeAnnotation = n, this.resetEndLocation(e.id));
	}
	parseAsyncArrowFromCallExpression(e, t) {
		return this.match(10) && (e.returnType = this.tsParseTypeAnnotation()), super.parseAsyncArrowFromCallExpression(e, t);
	}
	parseMaybeAssign(e, t) {
		let n, r, i;
		if (this.hasPlugin("jsx") && (this.match(138) || this.match(43))) {
		...
		if (!r?.error && !this.match(43)) return super.parseMaybeAssign(e, t);
		(!n || n === this.state) && (n = this.state.clone());
		let a, o = this.tryParse((n) => {
			...
			if ((r.type !== "ArrowFunctionExpression" || r.extra?.parenthesized) && n(), a?.params.length !== 0 && this.resetStartLocationFromNode(r, a), r.typeParameters = a, this.hasPlugin("jsx") && r.typeParameters.params.length === 1 && !r.typeParameters.extra?.trailingComma) {
				...
				e.constraint || this.raise(H.SingleTypeParameterWithoutTrailingComma, this.optionFlags & 256 ? u(e.loc.end, 1) : e, { typeParameterName: e.name.name });
			}
			return r;
		}, n);
		if (!o.error && !o.aborted) return a && this.reportReservedArrowTypeParam(a), o.node;
		if (!r && (hn(!this.hasPlugin("jsx")), i = this.tryParse(() => super.parseMaybeAssign(e, t), n), !i.error)) return i.node;
		if (r?.node) return this.state = r.failState, r.node;
		if (o.node) return this.state = o.failState, a && this.reportReservedArrowTypeParam(a), o.node;
		if (i?.node) return this.state = i.failState, i.node;
		throw r?.error || o.error || i?.error;
	}
	...
	isValidLVal(e, t, n, r) {
		switch (e) {
			...
			case "TSAsExpression":
			case "TSSatisfiesExpression":
			case "TSTypeAssertion": return (r !== 64 || !n) && ["expression", !0];
			default: return super.isValidLVal(e, t, n, r);
		}
	}
	parseBindingAtom() {
		return this.state.type === 74 ? this.parseIdentifier(!0) : super.parseBindingAtom();
	...
	checkCommaAfterRest(e) {
		return this.state.isAmbientContext && this.match(8) && this.lookaheadCharCode() === e ? (this.next(), !1) : super.checkCommaAfterRest(e);
	}
	isClassMethod() {
		return this.match(43) || super.isClassMethod();
	}
	...
	shouldParseArrow(e) {
		return this.match(10) ? e.every((e) => this.isAssignable(e, !0)) : super.shouldParseArrow(e);
	}
	shouldParseAsyncArrow() {
	...
	parseParenAndDistinguishExpression(e) {
		...
		let n = super.parseParenAndDistinguishExpression(e);
		return this.state.inConditionalConsequent = t, n;
	}
	canHaveLeadingDecorator() {
	...
	fillOptionalPropertiesForTSESLint(e) {
		switch (e.type) {
			...
			case "TSEnumMember":
				...
				return;
			case "TSImportType":
				e.qualifier ??= null, e.options ??= null, e.typeArguments ??= null;
				return;
			case "TSInterfaceDeclaration":
				e.declare ??= !1, e.extends ??= [];
				return;
			case "TSMappedType":
				e.optional ??= !1, e.readonly ??= void 0;
				return;
	...
	chStartsBindingIdentifierAndNotRelationalOperator(e, t) {
		if (M(e)) {
			if (pn.lastIndex = t, pn.test(this.input)) {
				let e = this.codePointAtPos(pn.lastIndex);
				if (!N(e) && e !== 92) return !1;
			}
			return !0;
		} else return e === 92;
...
function xn(e) {
	...
	return t && n.type !== "StringLiteral" && (n.type !== "TemplateLiteral" || n.expressions.length > 0) ? !1 : Tn(e.object);
}
function Sn(e, t) {
	let { type: n } = e;
	if (e.extra?.parenthesized) return !1;
	...
	return !!(Cn(e, t) || wn(e, t) || n === "TemplateLiteral" && e.expressions.length === 0 || xn(e));
}
function Cn(e, t) {
...
function wn(e, t) {
	if (e.type === "UnaryExpression") {
		...
		if (n === "-" && Cn(r, t)) return !0;
	}
	return !1;
}
function Tn(e) {
	return e.type === "Identifier" ? !0 : e.type !== "MemberExpression" || e.computed ? !1 : Tn(e.object);
}
var En = h`placeholders`({
	ClassNameIsRequired: "A class name is required.",
	UnexpectedSpace: "Unexpected space in placeholder."
}), Dn = (e) => class extends e {
	parsePlaceholder(e) {
		if (this.match(129)) {
			let t = this.startNode();
			return this.next(), this.assertNoSpace(), t.name = super.parseIdentifier(!0), this.assertNoSpace(), this.expect(129), this.finishPlaceholder(t, e);
		}
	}
	...
	getTokenFromCode(e) {
		e === 37 && this.input.charCodeAt(this.state.pos + 1) === 37 ? this.finishOp(129, 2) : super.getTokenFromCode(e);
	}
	parseExprAtom(e) {
	...
	isValidLVal(e, t, n, r) {
		return e === "Placeholder" || super.isValidLVal(e, t, n, r);
	}
	toAssignable(e, t) {
	...
	verifyBreakContinue(e, t) {
		e.label?.type !== "Placeholder" && super.verifyBreakContinue(e, t);
	}
	parseExpressionStatement(e, t) {
		if (t.type !== "Placeholder" || t.extra?.parenthesized) return super.parseExpressionStatement(e, t);
		if (this.match(10)) {
			let n = e;
	...
	parseClass(e, t, n) {
		...
		if (a) if (this.match(77) || this.match(129) || this.match(2)) e.id = a;
		else {
			if (n || !t) return e.id = null, e.body = this.finishPlaceholder(a, "ClassBody"), this.finishNode(e, r);
			throw this.raise(En.ClassNameIsRequired, this.state.startLoc);
		}
	...
	parseExport(e, t) {
		...
		let r = e;
		if (!this.isContextual(94) && !this.match(8)) return r.specifiers = [], r.source = null, r.declaration = this.finishPlaceholder(n, "Declaration"), this.finishNode(r, "ExportNamedDeclaration");
	...
	maybeParseExportDefaultSpecifier(e, t) {
		return e.specifiers?.length ? !0 : super.maybeParseExportDefaultSpecifier(e, t);
	}
	checkExport(e) {
		let { specifiers: t } = e;
		t?.length && (e.specifiers = t.filter((e) => e.exported.type === "Placeholder")), super.checkExport(e), e.specifiers = t;
	}
	parseImport(e) {
		let t = this.parsePlaceholder("Identifier");
		if (!t) return super.parseImport(e);
		if (e.specifiers = [], !this.isContextual(94) && !this.match(8)) return e.source = this.finishPlaceholder(t, "StringLiteral"), this.semicolon(), this.finishNode(e, "ImportDeclaration");
		let n = this.startNodeAtNode(t);
		return n.local = t, e.specifiers.push(this.finishNode(n, "ImportDefaultSpecifier")), this.eat(8) && (this.maybeParseStarImportSpecifier(e) || this.parseNamedImportSpecifiers(e)), this.expectContextual(94), e.source = this.parseImportSource(), this.semicolon(), this.finishNode(e, "ImportDeclaration");
	}
	parseImportSource() {
		return this.parsePlaceholder("StringLiteral") || super.parseImportSource();
	}
	assertNoSpace() {
		this.state.start > this.offsetToSourcePos(this.state.lastTokEndLoc.index) && this.raise(En.UnexpectedSpace, this.state.lastTokEndLoc);
	}
...
function jn(e) {
	...
	if (e.has("discardBinding") && e.get("discardBinding").syntaxType !== "void") throw Error("The 'discardBinding' plugin requires a 'syntaxType' option. Currently the only supported value is 'void'.");
...
var Mn = {
	...
	v8intrinsic: On,
	placeholders: Dn
}, Nn = Object.keys(Mn), Pn = class extends fn {
	constructor(e, t, n) {
		let r = le(e);
...
function Ln(e) {
	let t = {};
	for (let n of Object.keys(e)) t[n] = Le(e[n]);
	return t;
}
Ln(xe);
function U(e, t) {
	let n = Pn, r = /* @__PURE__ */ new Map();
	if (e?.plugins) {
...
function zn(e) {
	let t = [];
	for (let n of Nn) e.has(n) && t.push(n);
	let n = t.join("|"), r = Rn.get(n);
	if (!r) {
		r = Pn;
		for (let e of t) r = Mn[e](r);
		Rn.set(n, r);
	}
	return r;
}
...
var qn = Kn;
function Jn(e, t) {
	return t === !1 ? !1 : e.charAt(t) === "/" && e.charAt(t + 1) === "/" ? Hn(e, t) : t;
}
var Yn = Jn;
function Xn(e, t) {
	let n = null, r = t;
	for (; r !== n;) n = r, r = Vn(e, r), r = Wn(e, r), r = Yn(e, r), r = qn(e, r);
	return r;
}
var Zn = Xn;
function Qn(e) {
...
var er = $n, tr = Array.prototype.findLast ?? function(e) {
	for (let t = this.length - 1; t >= 0; t--) {
		let n = this[t];
		if (e(n, t, this)) return n;
	}
}, nr = i("findLast", function() {
	if (Array.isArray(this)) return tr;
}), rr = Symbol.for("comments");
function ir(e) {
	return this[e < 0 ? this.length + e : e];
}
var ar = i("at", function() {
	if (Array.isArray(this) || typeof this == "string") return ir;
});
function or(e) {
	let t = new Set(e);
...
function W(e) {
	...
	return n ? Math.min(W(n), t) : t;
}
var cr = 5, lr = 8, ur = 8, dr = (e) => (t) => t.label ? G(t.label) : W(t) + e, fr = (e) => e.__contentEnd ?? sr(e), pr = [
	"ExpressionStatement",
	"Directive",
	"ImportDeclaration",
	...
	["BreakStatement", dr(cr)],
	["ContinueStatement", dr(lr)],
	["DebuggerStatement", (e) => W(e) + ur],
	["VariableDeclaration", (e) => G(ar(0, e.declarations, -1))],
	...pr.map((e) => [e, fr])
]), hr = or(pr);
function G(e) {
	let { type: t } = e;
	return t === "IfStatement" ? G(e.alternate ?? e.consequent) : t === "ForInStatement" || t === "ForOfStatement" || t === "ForStatement" || t === "LabeledStatement" || t === "WithStatement" || t === "WhileStatement" ? G(e.body) : mr.get(t)?.(e) ?? sr(e);
}
var gr = or([
	"Block",
	"CommentBlock",
...
function br(e) {
	return vr(yr, e, (e) => gr(e) && e.value[0] === "*" && /@(?:type|satisfies)\b/.test(e.value));
}
function xr(e) {
	return o(0, e, /[^\n]/g, " ");
}
...
function Cr(e, t) {
	for (let n of t) {
		let t = W(n), r = G(n);
		e = e.slice(0, t) + Sr(e.slice(t, r)) + e.slice(r);
	}
	return e;
}
...
function Tr(e) {
	let t = e[rr];
	return vr(wr, t, (t) => Cr(e.originalText, t));
}
function Er(e) {
	if (!gr(e) || !e.value.includes("\n")) return [];
	let t = [];
...
function jr(e) {
	...
	for (let n = e.length - 1; n >= 0; n--) {
		let r = e[n];
		if (t && G(r) === W(t) && Ar(r) && Ar(t) && (e.splice(n + 1, 1), r.value += "*//*" + t.value, r.range = [W(r), G(t)], kr(r)), !_r(r) && !gr(r)) throw TypeError(`Unknown comment type: "${r.type}".`);
		t = r;
	}
}
function Mr(e) {
...
function q(e) {
	if (K !== null && typeof K.property) {
		let e = K;
		return K = q.prototype = null, e;
	}
	return K = q.prototype = e ?? Object.create(null), new q();
}
var Pr = 10;
for (let e = 0; e <= Pr; e++) q();
function Fr(e) {
	return q(e);
}
function Ir(e, t = "type") {
	Fr(e);
	function n(n) {
		let r = n[t], i = e[r];
...
var Lr = Ir, J = [
	...
	ArrayExpression: J[0],
	AssignmentExpression: J[1],
	BinaryExpression: J[1],
	InterpreterDirective: [],
	Directive: J[2],
	DirectiveLiteral: [],
	BlockStatement: J[3],
	...
	ConditionalExpression: J[6],
	ContinueStatement: J[4],
	DebuggerStatement: [],
	DoWhileStatement: J[7],
	EmptyStatement: [],
	ExpressionStatement: J[8],
	File: ["program"],
	ForInStatement: J[9],
	ForStatement: [
		"init",
	...
	FunctionDeclaration: J[10],
	FunctionExpression: J[10],
	...
	BooleanLiteral: [],
	RegExpLiteral: [],
	LogicalExpression: J[1],
	MemberExpression: J[11],
	NewExpression: J[5],
	Program: J[3],
	ObjectExpression: J[12],
	ObjectMethod: J[13],
	ObjectProperty: J[14],
	RestElement: [
		"argument",
	...
	ReturnStatement: J[15],
	SequenceExpression: J[16],
	ParenthesizedExpression: J[8],
	...
	UnaryExpression: J[15],
	UpdateExpression: J[15],
	VariableDeclaration: ["declarations"],
	VariableDeclarator: J[17],
	WhileStatement: J[7],
	...
	ClassBody: J[18],
	ClassExpression: J[19],
	ClassDeclaration: J[19],
	ExportAllDeclaration: [
		"source",
		"attributes",
		"exported"
	...
	ImportDefaultSpecifier: J[21],
	ImportNamespaceSpecifier: J[21],
	...
	YieldExpression: J[15],
	AwaitExpression: J[15],
	ImportExpression: ["source", "options"],
	BigIntLiteral: [],
	ExportNamespaceSpecifier: J[22],
	OptionalMemberExpression: J[11],
	OptionalCallExpression: J[5],
	ClassProperty: J[23],
	ClassPrivateProperty: J[23],
	ClassPrivateMethod: J[13],
	PrivateName: J[24],
	StaticBlock: J[18],
	ImportAttribute: J[25],
	AnyTypeAnnotation: [],
	ArrayTypeAnnotation: J[26],
	BooleanTypeAnnotation: [],
	BooleanLiteralTypeAnnotation: [],
	NullLiteralTypeAnnotation: [],
	ClassImplements: J[27],
	DeclareClass: [
		"id",
		"typeParameters",
		"extends",
	...
	DeclareInterface: J[28],
	DeclareModule: J[29],
	DeclareModuleExports: J[30],
	DeclareTypeAlias: J[31],
	DeclareOpaqueType: [
		"id",
		"typeParameters",
		"supertype",
	...
	DeclareExportDeclaration: J[20],
	DeclareExportAllDeclaration: ["source", "attributes"],
	DeclaredPredicate: J[2],
	...
	FunctionTypeParam: J[32],
	GenericTypeAnnotation: J[27],
	InferredPredicate: [],
	InterfaceExtends: J[27],
	InterfaceDeclaration: J[28],
	InterfaceTypeAnnotation: ["extends", "body"],
	IntersectionTypeAnnotation: J[33],
	MixedTypeAnnotation: [],
	EmptyTypeAnnotation: [],
	NullableTypeAnnotation: J[30],
	...
	QualifiedTypeIdentifier: J[34],
	StringLiteralTypeAnnotation: [],
	StringTypeAnnotation: [],
	SymbolTypeAnnotation: [],
	ThisTypeAnnotation: [],
	TupleTypeAnnotation: J[35],
	TypeofTypeAnnotation: ["argument", "typeArguments"],
	TypeAlias: J[31],
	TypeAnnotation: J[30],
	TypeCastExpression: J[36],
	TypeParameter: [
		"bound",
		"default",
		"variance"
	],
	TypeParameterDeclaration: J[37],
	TypeParameterInstantiation: J[37],
	UnionTypeAnnotation: J[33],
	Variance: [],
	VoidTypeAnnotation: [],
	EnumDeclaration: J[29],
	EnumBooleanBody: J[38],
	EnumNumberBody: J[38],
	EnumStringBody: J[38],
	EnumSymbolBody: J[38],
	EnumBooleanMember: J[17],
	EnumNumberMember: J[17],
	EnumStringMember: J[17],
	EnumDefaultedMember: J[24],
	IndexedAccessType: J[39],
	OptionalIndexedAccessType: J[39],
	...
	JSXEmptyExpression: [],
	JSXExpressionContainer: J[8],
	JSXSpreadChild: J[8],
	JSXIdentifier: [],
	JSXMemberExpression: J[11],
	...
	ClassAccessorProperty: J[40],
	Decorator: J[8],
	DoExpression: J[18],
	ExportDefaultSpecifier: J[22],
	ModuleExpression: J[18],
	TopicReference: [],
	VoidPattern: [],
	TSParameterProperty: ["parameter", "decorators"],
	TSDeclareFunction: J[41],
	TSDeclareMethod: J[42],
	TSQualifiedName: J[1],
	TSCallSignatureDeclaration: J[43],
	TSConstructSignatureDeclaration: J[43],
	TSPropertySignature: ["key", "typeAnnotation"],
	TSMethodSignature: J[42],
	...
	TSThisType: [],
	TSFunctionType: J[43],
	TSConstructorType: J[43],
	TSTypeReference: ["typeName", "typeArguments"],
	TSTypePredicate: J[44],
	...
	TSUnionType: J[33],
	TSIntersectionType: J[33],
	TSConditionalType: J[45],
	TSInferType: J[46],
	TSParenthesizedType: J[30],
	TSTypeOperator: J[30],
	TSIndexedAccessType: J[39],
	TSMappedType: [
		"key",
		"constraint",
		"nameType",
	...
	TSLiteralType: J[47],
	TSClassImplements: J[48],
	TSInterfaceHeritage: J[48],
	TSInterfaceDeclaration: J[28],
	TSInterfaceBody: J[18],
	TSTypeAliasDeclaration: [
		"id",
		"typeParameters",
		"typeAnnotation"
	],
	TSInstantiationExpression: J[48],
	TSAsExpression: J[36],
	TSSatisfiesExpression: J[36],
	TSTypeAssertion: J[36],
	TSEnumBody: J[38],
	TSEnumDeclaration: J[29],
	TSEnumMember: ["id", "initializer"],
	TSModuleDeclaration: J[29],
	TSModuleBlock: J[18],
	TSImportType: [
		"source",
		"options",
	...
	TSExternalModuleReference: J[8],
	TSNonNullExpression: J[8],
	TSExportAssignment: J[8],
	TSNamespaceExportDeclaration: J[24],
	TSTypeAnnotation: J[30],
	TSTypeParameterInstantiation: J[37],
	TSTypeParameterDeclaration: J[37],
	TSTypeParameter: [
		"name",
		"constraint",
		"default"
	...
	ChainExpression: J[8],
	Literal: [],
	MethodDefinition: J[14],
	PrivateIdentifier: [],
	Property: J[25],
	PropertyDefinition: J[23],
	AccessorProperty: J[40],
	TSAbstractAccessorProperty: J[49],
	TSAbstractKeyword: [],
	TSAbstractMethodDefinition: J[25],
	TSAbstractPropertyDefinition: J[49],
	TSAsyncKeyword: [],
	TSDeclareKeyword: [],
	...
	ComponentTypeParameter: J[32],
	ConditionalTypeAnnotation: J[45],
	DeclareComponent: [
		"id",
		"params",
		"rest",
	...
	DeclareEnum: J[29],
	DeclareHook: J[24],
	DeclareNamespace: J[29],
	EnumBigIntBody: J[38],
	EnumBigIntMember: J[17],
	EnumBody: J[38],
	HookDeclaration: J[41],
	HookTypeAnnotation: [
		"params",
		"returnType",
		"rest",
	...
	InferTypeAnnotation: J[46],
	KeyofTypeAnnotation: J[15],
	MatchArrayPattern: ["elements", "rest"],
	MatchAsPattern: ["pattern", "target"],
	MatchBindingPattern: J[24],
	MatchExpression: J[50],
	MatchExpressionCase: J[51],
	MatchIdentifierPattern: J[24],
	MatchInstanceObjectPattern: J[52],
	MatchInstancePattern: ["targetConstructor", "properties"],
	MatchLiteralPattern: J[47],
	MatchMemberPattern: ["base", "property"],
	MatchObjectPattern: J[52],
	MatchObjectPatternProperty: ["key", "pattern"],
	MatchOrPattern: ["patterns"],
	MatchRestPattern: J[15],
	MatchStatement: J[50],
	MatchStatementCase: J[51],
	MatchUnaryPattern: J[15],
	...
	QualifiedTypeofIdentifier: J[34],
	RecordDeclaration: [
		"id",
		"typeParameters",
		"implements",
	...
	RecordExpressionProperties: J[12],
	SatisfiesExpression: J[36],
	...
	NGMicrosyntaxLet: J[25],
	NGRoot: J[53],
	JsExpressionRoot: J[53],
	JsonRoot: J[53],
	TSJSDocAllType: [],
	TSJSDocUnknownType: [],
	TSJSDocNullableType: J[30],
	TSJSDocNonNullableType: J[30]
});
function zr(e, t) {
	if (!Nr(e)) return e;
	if (Array.isArray(e)) {
		for (let n = 0; n < e.length; n++) e[n] = zr(e[n], t);
		return e;
	}
	if (t.onEnter) {
		let n = t.onEnter(e) ?? e;
		if (n !== e) return zr(n, t);
		e = n;
	}
	let n = Rr(e);
	for (let r = 0; r < n.length; r++) e[n[r]] = zr(e[n[r]], t);
...
function Vr(e, t) {
	let { text: n, astType: r } = t, i = r === "oxc-ts", { comments: a } = e;
	jr(a);
	let o = e.type === "File" ? e.program : e;
	o.interpreter && (a.unshift(o.interpreter), delete o.interpreter), e.hashbang && (i && a.unshift(e.hashbang), delete e.hashbang), e.type === "Program" && (e.range = [0, n.length]);
	let s;
	return e = Br(e, {
		onEnter(t) {
			switch (Wr(t, a, n), t.type) {
				case "ParenthesizedExpression": {
					let { expression: e } = t, r = W(t);
					if (e.type === "TypeCastExpression") return e.range = [r, G(t)], e;
					let o = !1;
					if (!i) {
						if (!s) {
							s = [];
							for (let e of a) br(e) && s.push(G(e));
						}
						let e = nr(0, s, (e) => e <= r);
						o = e && n.slice(e, r).trim().length === 0;
					}
				...
				case "TemplateElement":
					(r === "flow" || r === "hermes" || r === "espree" || r === "typescript" || i) && (t.range = [W(t) + 1, G(t) - (t.tail ? 1 : 2)]);
					break;
				...
				case "TupleTypeAnnotation":
					...
					break;
				case "ImportDeclaration":
					r === "hermes" && t.assertions && !t.attributes && (t.attributes = t.assertions, delete t.assertions);
					break;
			}
		},
		onLeave(e) {
...
function Wr(e, t, n) {
	...
	--r;
	let a = i.slice(W(e), r), o = a.trimEnd();
	e.__contentEnd = r - (a.length - o.length);
}
var Gr = Vr;
function Kr(e, t) {
...
var qr = Kr, Jr = "Unexpected parseExpression() input: ";
function Yr(e) {
	let { message: t, loc: n, reasonCode: r } = e;
	if (!n) return e;
	let { line: i, column: a } = n, o = e;
	(r === "MissingPlugin" || r === "MissingOneOfPlugins") && (t = "Unexpected token.", o = void 0);
	let s = ` (${i}:${a})`;
	return t.endsWith(s) && (t = t.slice(0, -s.length)), t.startsWith(Jr) && (t = t.slice(Jr.length)), qr(t, {
		loc: { start: {
			line: i,
			column: a + 1
		} },
...
var Xr = Yr, Zr = /\*\/$/, Qr = /^\/\*\*?/, $r = /^\s*(\/\*\*?(.|\r?\n)*?\*\/)/, ei = /(^|\s+)\/\/([^\n\r]*)/g, ti = /^(\r?\n)+/, ni = /(?:^|\r?\n) *(@[^\n\r]*?) *\r?\n *(?![^\n\r@]*\/\/[^]*)([^\s@][^\n\r@]+?) *\r?\n/g, ri = /(?:^|\r?\n) *@(\S+) *([^\n\r]*)/g, ii = /(\r?\n|^) *\* ?/g, ai = [];
function oi(e) {
	let t = e.match($r);
	return t ? t[0].trimStart() : "";
}
function si(e) {
	e = o(0, e.replace(Qr, "").replace(Zr, ""), ii, "$1");
	let t = "";
	for (; t !== e;) t = e, e = o(0, e, ni, "\n$1 $2\n");
	e = e.replace(ti, "").trimEnd();
	let n = Object.create(null), r = o(0, e, ri, "").replace(ti, "").trimEnd(), i;
	for (; i = ri.exec(e);) {
		let e = o(0, i[2], ei, "");
...
function ui(e) {
	...
	let { pragmas: n, comments: r } = si(oi(e));
	return {
		shebang: t,
		text: e,
		pragmas: n,
...
function di(e) {
	let { pragmas: t } = ui(e);
	return li.some((e) => s(t, e));
}
function fi(e) {
	let { pragmas: t } = ui(e);
	return ci.some((e) => s(t, e));
}
function pi(e) {
...
var Y = pi, mi = "module", hi = "commonjs";
function gi(e) {
	if (typeof e == "string") {
		if (e = e.toLowerCase(), /\.(?:mjs|mts)$/i.test(e)) return mi;
		if (/\.(?:cjs|cts)$/i.test(e)) return hi;
	}
}
function _i(e) {
	let { type: t = "JsExpressionRoot", expression: n, comments: r = n?.comments ?? [], text: i, rootMarker: a } = e, o = {
		type: t,
		comments: r,
		range: [0, i.length],
		rootMarker: a
	};
	return n && (delete n.comments, o.node = n), o;
}
var vi = _i, X = (e) => Y(Ti(e)), yi = {
	sourceType: mi,
	...
	tokens: !1,
	ranges: !1
}, bi = "v8intrinsic", xi = [["pipelineOperator", {
	proposal: "hack",
	topicToken: "%"
}], ["pipelineOperator", { proposal: "fsharp" }]], Z = (e, t = yi) => ({
	...t,
	plugins: [...t.plugins, ...e]
}), Si = /@(?:no)?flow\b/;
function Ci(e, t) {
	...
	let r = Zn(e, 0);
	return r !== !1 && (e = e.slice(0, r)), Si.test(e);
}
function wi(e, t, n) {
	let r = e(t, n), i = r.errors.find((e) => !Ei.has(e.reasonCode));
	if (i) throw i;
	return r;
}
function Ti({ isExpression: e = !1, optionsCombinations: t }) {
	return (n, r = {}) => {
		let { filepath: i } = r;
		if (typeof i != "string" && (i = void 0), (r.parser === "babel" || r.parser === "__babel_estree") && Ci(n, i)) return r.parser = "babel-flow", Mi.parse(n, r);
		let a = t, o = r.__babelSourceType ?? gi(i);
		o && o !== mi && (a = a.map((e) => ({
			...e,
			sourceType: o,
			...o === hi ? {
		...
		let s = /%[A-Z]/.test(n);
		n.includes("|>") ? a = (s ? [...xi, bi] : xi).flatMap((e) => a.map((t) => Z([e], t))) : s && (a = a.map((e) => Z([bi], e)));
		let c = e ? In : Fn, l;
		try {
			l = Qn(a.map((e) => () => wi(c, n, e)));
		} catch ({ errors: [e] }) {
			throw Xr(e);
		}
		return e && (l = vi({
...
]), Di = [Z(["jsx"])], Oi = X({ optionsCombinations: Di }), ki = X({ optionsCombinations: [Z(["jsx", "typescript"]), Z(["typescript"])] }), Ai = X({
	isExpression: !0,
	optionsCombinations: [Z(["jsx"])]
}), ji = X({
	isExpression: !0,
	optionsCombinations: [Z(["typescript"])]
}), Mi = X({ optionsCombinations: [Z([
	"jsx",
	["flow", { all: !0 }],
	"flowComments"
])] }), Ni = X({ optionsCombinations: Di.map((e) => Z(["estree"], e)) }), Pi = {};
t(Pi, {
	json: () => Bi,
	"json-stringify": () => Ui,
	json5: () => Vi,
...
function Ri(e) {
	let t = Fn(e, Li), { program: n } = t;
	if (n.body.length === 0 && n.directives.length === 0 && !n.interpreter) return { comments: t.comments };
}
function zi(e, t = {}) {
	let { allowComments: n = !0, allowEmpty: r = !1 } = t, i, a;
	try {
		i = In(e, Li), a = i.comments;
	} catch (t) {
		if (r && t.code === "BABEL_PARSER_SYNTAX_ERROR" && t.reasonCode === "ParseExpressionEmptyInput") try {
			({comments: a} = Ri(e));
		} catch {}
		if (!a) throw Xr(t);
	}
	if (!n && Ii(a)) throw Q(a[0], "Comment");
	return (!r || i) && $(i), i = vi({
		type: "JsonRoot",
		expression: i,
		comments: a,
...
function Q(e, t) {
	let [n, r] = [e.loc.start, e.loc.end].map(({ line: e, column: t }) => ({
		line: e,
		column: t + 1
	}));
	return qr(`${t} is not allowed in JSON.`, { loc: {
		start: n,
		end: r
	} });
}
function $(e) {
	switch (e.type) {
		case "ArrayExpression":
			for (let t of e.elements) t !== null && $(t);
			return;
		case "ObjectExpression":
			for (let t of e.properties) $(t);
			return;
		case "ObjectProperty":
			if (e.computed) throw Q(e.key, "Computed key");
			if (e.shorthand) throw Q(e.key, "Shorthand property");
			e.key.type !== "Identifier" && $(e.key), $(e.value);
			return;
		case "UnaryExpression": {
			let { operator: t, argument: n } = e;
			if (t !== "+" && t !== "-") throw Q(e, `Operator '${e.operator}'`);
			if (n.type === "NumericLiteral" || n.type === "Identifier" && (n.name === "Infinity" || n.name === "NaN")) return;
			throw Q(n, `Operator '${t}' before '${n.type}'`);
		}
		case "Identifier":
			if (e.name !== "Infinity" && e.name !== "NaN" && e.name !== "undefined") throw Q(e, `Identifier '${e.name}'`);
			return;
		case "TemplateLiteral":
			if (Ii(e.expressions)) throw Q(e.expressions[0], "'TemplateLiteral' with expression");
			for (let t of e.quasis) $(t);
			return;
		case "NullLiteral":
		case "BooleanLiteral":
		case "NumericLiteral":
...
var Bi = Y({
	...
	hasPragma: () => !0,
	hasIgnorePragma: () => !1
}), Vi = Y((e) => zi(e)), Hi = Y((e) => zi(e, { allowEmpty: !0 })), Ui = Y({
	parse: (e) => zi(e, { allowComments: !1 }),
...
//#endregion
export { n as default, Wi as parsers };
